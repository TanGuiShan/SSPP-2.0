...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */let O;function B(e,t){return(l,r,i)=>{const o=l=>{const i=l.renderRoot?.querySelector(e)??null;if(null===i&&t&&!l.hasUpdated){const t="object"==typeof r?r.name:r;O("",`@query'd field ${JSON.stringify(String(t))} with the 'cache' flag set for selector '${e}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return i};if(t){const{get:e,set:t}="object"==typeof r?l:i??(()=>{const e=Symbol(`${String(r)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return $(l,r,{get(){let l=e.call(this);return void 0===l&&(l=o(this),(null!==l||this.hasUpdated)&&t.call(this,l)),l}})}return $(l,r,{get(){return o(this)}})}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */const Be=$e(class extends Oe{constructor(e){if(super(e),e.type!==He||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const r=!!t[e];r===this._previousClasses.has(e)||this._staticClasses?.has(e)||(r?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return de}}),Se=e=>e??he;
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,vt=n`.text-primary{color:var(--sgds-primary-rgb)!important}.text-secondary{color:var(--sgds-secondary-rgb)!important}.text-success{color:var(--sgds-success-rgb)!important}.text-info{color:var(--sgds-info-rgb)!important}.text-warning{color:var(--sgds-warning-rgb)!important}.text-danger{color:var(--sgds-danger-rgb)!important}.text-light{color:var(--sgds-light-rgb)!important}.text-dark{color:var(--sgds-dark-rgb)!important}.text-muted{color:var(--sgds-secondary-color)!important}`;class ut extends Xe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Ee`
    ...
    `}}ut.styles=[...Xe.styles,vt,ht],e([P({type:String,reflect:!0})],ut.prototype,"variant",void 0),e([P({type:String,reflect:!0})],ut.prototype,"tone",void 0),e([P({type:String,reflect:!0})],ut.prototype,"size",void 0),e([P({reflect:!0,type:String})],ut.prototype,"label",void 0),e([P({type:String,reflect:!0})],ut.prototype,"orientation",void 0);var pt=n`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sgds-dimension-48,56px);min-width:unset;padding:0;width:var(--sgds-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sgds-dimension-56);min-width:unset;padding:0;width:var(--sgds-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sgds-dimension-40);min-width:unset;padding:0;width:var(--sgds-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sgds-dimension-32);min-width:unset;padding:0;width:var(--sgds-dimension-32)}`;class ft extends nt{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?Ie`a`:Ie`button`;return Ee`
      ...
      >
        ...
        ${this.suffix?Ee`<span class="form-control-suffix">${this.suffix}</span>`:he}
        <slot name="trailing-icon">
          ${this.loading?Ee`<sgds-spinner size="sm"></sgds-spinner>`:he}
          ${this.valid?Ee`<sgds-icon name="check-circle-fill" class="valid-icon"></sgds-icon>`:he}
        </slot>
      </div>
    `}_renderPasswordToggle(){return Ee`<sgds-icon
      tabIndex="0"
      role="button"
      name=${this._showPassword?"eye-slash-fill":"eye-fill"}
      @click=${()=>this._showPassword=!this._showPassword}
    ></sgds-icon>`}_inputType(){return"password"===this.type&&this._showPassword?"text":this.type}_renderFeedback(){const e="both"===this.hasFeedback||"text"===this.hasFeedback;return this.invalid&&e?Ee` <div class="invalid-feedback-container">
    ...
    `}}Ct.styles=[...et.styles,Ke,tt,gt,xt],Ct.dependencies={"sgds-input":_t,"sgds-icon-button":ft},e([B("sgds-icon-button[ariaLabel^='increase by']")],Ct.prototype,"plusBtn",void 0),e([B("sgds-icon-button[ariaLabel^='decrease by']")],Ct.prototype,"minusBtn",void 0),e([P({type:Number,reflect:!0})],Ct.prototype,"value",void 0),e([P({type:Number})],Ct.prototype,"step",void 0),e([P({type:Number})],Ct.prototype,"min",void 0),e([P({type:Number})],Ct.prototype,"max",void 0),e([P({type:String,reflect:!0})],Ct.prototype,"hasFeedback",void 0),e([P({type:String,reflect:!0})],Ct.prototype,"invalidFeedback",void 0),e([P({type:Boolean,reflect:!0})],Ct.prototype,"readonly",void 0),e([lt()],Ct.prototype,"defaultValue",void 0),e([S("sgds-input")],Ct.prototype,"_sgdsInput",void 0),bt="sgds-quantity-toggle",Zt=Ct,customElements.get(bt)||customElements.define(bt,Zt);var yt=se`
...
`,rl=Object.freeze({__proto__:null,default:ll}),il=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ol=Object.freeze({__proto__:null,default:il}),nl=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,cl=Object.freeze({__proto__:null,default:sl}),dl=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hl=Object.freeze({__proto__:null,default:dl}),vl=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ql=Object.freeze({__proto__:null,default:Xl}),er=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rr=Object.freeze({__proto__:null,default:lr}),ir=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,or=Object.freeze({__proto__:null,default:ir}),nr=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cr=Object.freeze({__proto__:null,default:sr}),dr=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hr=Object.freeze({__proto__:null,default:dr}),vr=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qr=Object.freeze({__proto__:null,default:Xr}),ei=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ri=Object.freeze({__proto__:null,default:li}),ii=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oi=Object.freeze({__proto__:null,default:ii}),ni=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,ci=Object.freeze({__proto__:null,default:si}),di=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hi=Object.freeze({__proto__:null,default:di}),vi=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qi=Object.freeze({__proto__:null,default:Xi}),eo=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ro=Object.freeze({__proto__:null,default:lo}),io=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oo=Object.freeze({__proto__:null,default:io}),no=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cn=Object.freeze({__proto__:null,default:sn}),dn=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,hn=Object.freeze({__proto__:null,default:dn}),vn=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ra=Object.freeze({__proto__:null,default:la}),ia=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oa=Object.freeze({__proto__:null,default:ia}),na=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ca=Object.freeze({__proto__:null,default:sa}),da=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ha=Object.freeze({__proto__:null,default:da}),va=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rs=Object.freeze({__proto__:null,default:ls}),is=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,os=Object.freeze({__proto__:null,default:is}),ns=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,hs=Object.freeze({__proto__:null,default:ds}),vs=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rc=Object.freeze({__proto__:null,default:lc}),ic=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oc=Object.freeze({__proto__:null,default:ic}),nc=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,hc=Object.freeze({__proto__:null,default:dc}),vc=se`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
