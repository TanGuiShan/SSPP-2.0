...
/**
   ...
   */var Ie,De,Re,We=i`:host{--btn-font-weight:var(--sgds-font-weight-regular);--btn-color:var(--sgds-color-fixed-light);--btn-bg:var(--sgds-primary-surface-default);--btn-hover-bg:var(--sgds-primary-surface-emphasis);--btn-border-radius:var(--sgds-border-radius-md);--btn-opacity:var(--sgds-opacity-100,1)}:host([variant=danger]){--btn-bg:var(--sgds-danger-surface-default);--btn-hover-bg:var(--sgds-danger-surface-emphasis);--btn-color:var(--sgds-color-fixed-light)}:host([variant=primary][tone=brand]){--btn-bg:var(--sgds-primary-surface-default);--btn-color:var(--sgds-color-fixed-light)}:host([variant=outline]){--btn-border-width:var(--sgds-border-width-1)}:host([variant=outline][tone=brand]){--btn-border-color:var(--sgds-primary-border-color-default);--btn-bg:var(--sgds-bg-transparent);--btn-color:var(--sgds-primary-color-default);--btn-hover-bg:var(--sgds-primary-bg-translucent)}:host([variant=ghost][tone=brand]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-primary-surface-translucent);--btn-color:var(--sgds-primary-color-default)}:host([variant=primary][tone=danger]){--btn-bg:var(--sgds-danger-surface-default);--btn-hover-bg:var(--sgds-danger-surface-emphasis);--btn-color:var(--sgds-color-fixed-light)}:host([variant=outline][tone=danger]){--btn-border-color:var(--sgds-danger-border-color-default);--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-danger-surface-translucent);--btn-color:var(--sgds-danger-color-default)}:host([variant=ghost][tone=danger]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-danger-surface-translucent);--btn-color:var(--sgds-danger-color-default)}:host([variant=primary][tone=fixed-light]){--btn-bg:var(--sgds-surface-fixed-light);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 0%,var(--sgds-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 100%),var(--sgds-surface-fixed-light,#fff);--btn-color:var(--sgds-color-fixed-dark)}:host([variant=outline][tone=fixed-light]){--btn-border-color:var(--sgds-border-color-fixed-light);--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-fixed-dark) 0%,var(--sgds-bg-translucent-fixed-dark) 100%),var(--sgds-bg-transparent);--btn-color:var(--sgds-color-fixed-light)}:host([variant=ghost][tone=fixed-light]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-fixed-dark) 0%,var(--sgds-bg-translucent-fixed-dark) 100%),var(--sgds-bg-transparent);--btn-color:var(--sgds-color-fixed-light)}:host([variant=primary][tone=neutral]){--btn-bg:var(--sgds-surface-inverse);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-inverse) 0%,var(--sgds-bg-translucent-inverse) 100%),var(--sgds-surface-inverse);--btn-color:var(--sgds-color-inverse)}:host([variant=outline][tone=neutral]){--btn-border-color:var(--sgds-border-color-emphasis);--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-inverse) 0%,var(--sgds-bg-translucent-inverse) 100%),var(--sgds-bg-translucent-subtle);--btn-color:var(--sgds-color-default)}:host([variant=ghost][tone=neutral]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-bg-translucent-subtle);--btn-color:var(--sgds-color-default)}:host([variant=ghost]) .btn,:host([variant=outline]) .btn,:host([variant=primary]) .btn{color:var(--btn-color)}:host([variant=outline]) .btn{border:var(--btn-border-width) solid var(--btn-border-color)}:host([size=lg]) .btn{font-size:var(--sgds-font-size-label-lg);height:var(--sgds-dimension-56);line-height:var(--sgds-line-height-md);min-width:var(--sgds-dimension-112);padding:var(--sgds-padding-none) var(--sgds-padding-xl)}:host([size=sm]) .btn{font-size:var(--sgds-font-size-label-sm);height:var(--sgds-dimension-40);line-height:var(--sgds-line-height-2-xs);min-width:var(--sgds-dimension-80);padding:var(--sgds-padding-none) var(--sgds-padding-md)}:host([size=xs]) .btn{font-size:var(--sgds-font-size-label-xs);height:var(--sgds-dimension-32);line-height:var(--sgds-line-height-3-xs);min-width:var(--sgds-dimension-64);padding:var(--sgds-padding-none) var(--sgds-padding-sm)}.btn{align-items:center;background-color:var(--btn-bg);border:var(--sgds-border-width-1) solid var(--sgds-border-color-transparent);border-radius:var(--btn-border-radius);color:var(--sgds-color-fixed-light);cursor:pointer;display:inline-flex;font-size:var(--sgds-font-size-label-md);font-weight:var(--btn-font-weight);gap:var(--sgds-gap-2-xs);height:var(--sgds-dimension-48);justify-content:center;line-height:var(--sgds-line-height-xs);min-width:var(--sgds-dimension-96);opacity:var(--btn-opacity);padding:var(--sgds-padding-none) var(--sgds-padding-lg);text-align:center;text-decoration:none;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;user-select:none;vertical-align:middle;white-space:nowrap;width:inherit}@media (prefers-reduced-motion:reduce){.btn{transition:none}}.btn.active,.btn:hover{background:var(--btn-hover-bg)}.btn:focus-visible{background:var(--btn-hover-bg);border-color:transparent;outline:var(--sgds-outline-focus);outline-offset:var(--sgds-outline-offset-focus)}.btn.disabled,.btn:disabled{color:var(--btn-color);cursor:not-allowed;opacity:var(--sgds-opacity-40)}.btn.loading{cursor:default}.btn slot::slotted(*){color:var(--btn-color)}`;class qe extends Oe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.active=!1,this.disabled=!1,this.target="_self"}focus(e){this.button.focus(e)}click(){this.button.click()}blur(){this.button.blur()}_handleBlur(){this.emit("sgds-blur")}_handleFocus(){this.emit("sgds-focus")}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation()}_handleKeydown(e){if("Enter"===e.key&&this.loading)return e.preventDefault(),void e.stopPropagation()}_assignSpinnerSize(e){return"xs"===e||"sm"===e?"xs":"md"===e||"lg"===e?"sm":void 0}_assignSpinnerTone(e,t){return"fixed-light"===e&&"primary"===t?"fixed-dark":"neutral"===e&&"primary"===t?"inverse":"fixed-light"===e||"primary"===t?"fixed-light":"neutral"!==e||"outline"!==t&&"ghost"!==t?"brand":"neutral"}}qe.styles=[...Oe.styles,We],e([(De=".btn",(e,t,l)=>{const r=e=>{const l=e.renderRoot?.querySelector(De)??null;if(null===l&&Re&&!e.hasUpdated){const e="object"==typeof t?t.name:t;ze("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${De}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(Re){const{get:o,set:n}="object"==typeof t?e:l??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Ve(e,t,{get(){let e=o.call(this);return void 0===e&&(e=r(this),(null!==e||this.hasUpdated)&&n.call(this,e)),e}})}return Ve(e,t,{get(){return r(this)}})})],qe.prototype,"button",void 0),e([Pe({reflect:!0})],qe.prototype,"variant",void 0),e([Pe({reflect:!0})],qe.prototype,"tone",void 0),e([Pe({reflect:!0})],qe.prototype,"size",void 0),e([Pe({type:Boolean,reflect:!0})],qe.prototype,"active",void 0),e([Pe({type:Boolean,reflect:!0})],qe.prototype,"disabled",void 0),e([Pe({type:String,reflect:!0})],qe.prototype,"href",void 0),e([Pe({type:String,reflect:!0})],qe.prototype,"target",void 0),e([Pe({type:String,reflect:!0})],qe.prototype,"download",void 0),e([Pe({type:String})],qe.prototype,"ariaLabel",void 0),e([Pe({type:Boolean})],qe.prototype,"loading",void 0);class Fe{constructor(e,...t){this.slotNames=[],(this.host=e).addController(this),this.slotNames=t,this.handleSlotChange=this.handleSlotChange.bind(this)}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{var t;if(e.nodeType===e.TEXT_NODE&&""!==(null===(t=e.textContent)||void 0===t?void 0:t.trim()))return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if("sl-visually-hidden"===t.tagName.toLowerCase())return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return null!==this.host.querySelector(`:scope > [slot="${e}"]`)}test(e){return"[default]"===e?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){var e;null===(e=this.host.shadowRoot)||void 0===e||e.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){var e;null===(e=this.host.shadowRoot)||void 0===e||e.removeEventListener("slotchange",this.handleSlotChange)}handleSlotChange(e){const t=e.target;(this.slotNames.includes("[default]")&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()}}class Ke{constructor(e,t){(this.host=e).addController(this),this.options=Object.assign({form:e=>e.closest("form")},t)}hostConnected(){this.form=this.options.form(this.host)}hostDisconnected(){this.form&&(this.form=void 0)}doAction(e,t){if(this.form){const l=document.createElement("button");l.type=e,l.style.position="absolute",l.style.width="0",l.style.height="0",l.style.clipPath="inset(50%)",l.style.overflow="hidden",l.style.whiteSpace="nowrap",t&&(["formaction","formmethod","formnovalidate","formtarget"].forEach(e=>{t.hasAttribute(e)&&l.setAttribute(e,t.getAttribute(e))}),"submit"===e&&t.hasAttribute("name")&&(l.name=t.getAttribute("name"),l.value=t.getAttribute("value")||"")),this.form.append(l),l.click(),l.remove()}}reset(e){this.doAction("reset",e)}submit(e){this.doAction("submit",e)}}var Je=i`::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}`,Ge=i`:host{display:inline-block}:host([fullWidth]),:host([fullWidth]) .btn{width:100%}:host([fullWidth]) .btn.has-left-icon{justify-content:flex-start}:host([fullWidth]) .btn.has-right-icon{justify-content:space-between}:host([fullWidth]) .btn.has-left-icon.has-right-icon{justify-content:center}.btn span{padding:0 var(--sgds-padding-2-xs)}.btn.no-icon{gap:var(--sgds-gap-none)}.loading{cursor:default}`;class Xe extends qe{constructor(){super(...arguments),this.formSubmitController=new Ke(this,{form:e=>{if(e.hasAttribute("form")){const t=e.getRootNode(),l=e.getAttribute("form");return t.getElementById(l)}return e.closest("form")}}),this.type="button",this.fullWidth=!1,this.hasLeftIconSlot=!1,this.hasRightIconSlot=!1,this.hasSlotController=new Fe(this,"leftIcon","rightIcon"),this._clickHandler=()=>{"submit"===this.type&&this.formSubmitController.submit(this),"reset"===this.type&&this.formSubmitController.reset(this)}}updated(){this.hasLeftIconSlot||(this.hasLeftIconSlot=this.hasSlotController.test("leftIcon")),this.hasRightIconSlot||(this.hasRightIconSlot=this.hasSlotController.test("rightIcon"))}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation();this.removeEventListener("click",this._clickHandler),this.addEventListener("click",this._clickHandler)}render(){const e=this.href,t=e?Ne`a`:Ne`button`,l=!this.hasLeftIconSlot&&!this.hasRightIconSlot;return Ue`
      ...
      >
       ${this.loading?Ue`<sgds-spinner
               size=${ke(this._assignSpinnerSize(this.size))}
               tone=${ke(this._assignSpinnerTone(this.tone,this.variant))}
             ></sgds-spinner>`:Ue`<slot name="leftIcon"></slot>
               <span><slot></slot></span>
               <slot name="rightIcon"></slot>`}
      
      </${t}>
    `}}Xe.styles=[...qe.styles,Je,Ge],e([Pe({type:String,reflect:!0})],Xe.prototype,"name",void 0),e([Pe({type:String,reflect:!0})],Xe.prototype,"value",void 0),e([Pe({type:String,reflect:!0})],Xe.prototype,"type",void 0),e([Pe({type:String,reflect:!0})],Xe.prototype,"form",void 0),e([Pe({type:String,reflect:!0,attribute:"formaction"})],Xe.prototype,"formAction",void 0),e([Pe({type:String,reflect:!0,attribute:"formmethod"})],Xe.prototype,"formMethod",void 0),e([Pe({attribute:"formnovalidate",type:Boolean,reflect:!0})],Xe.prototype,"formNoValidate",void 0),e([Pe({type:String,reflect:!0,attribute:"formtarget"})],Xe.prototype,"formTarget",void 0),e([Pe({type:Boolean,reflect:!0})],Xe.prototype,"fullWidth",void 0),e([Pe({type:Boolean})],Xe.prototype,"hasLeftIconSlot",void 0),e([Pe({type:Boolean})],Xe.prototype,"hasRightIconSlot",void 0);const Ye={announcement:()=>Promise.resolve().then(function(){return vt}),archive:()=>Promise.resolve().then(function(){return gt}),"arrow-bar-down":()=>Promise.resolve().then(function(){return ft}),"arrow-bar-left":()=>Promise.resolve().then(function(){return mt}),"arrow-bar-right":()=>Promise.resolve().then(function(){return bt}),"arrow-bar-up":()=>Promise.resolve().then(function(){return xt}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Mt}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Pt}),"arrow-circle-right":()=>Promise.resolve().then(function(){return Vt}),"arrow-circle-up":()=>Promise.resolve().then(function(){return $t}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Bt}),"arrow-down":()=>Promise.resolve().then(function(){return St}),"arrow-left":()=>Promise.resolve().then(function(){return kt}),"arrow-repeat":()=>Promise.resolve().then(function(){return Et}),"arrow-right":()=>Promise.resolve().then(function(){return Tt}),"arrow-square-down":()=>Promise.resolve().then(function(){return It}),"arrow-square-left":()=>Promise.resolve().then(function(){return Rt}),"arrow-square-right":()=>Promise.resolve().then(function(){return qt}),"arrow-square-up":()=>Promise.resolve().then(function(){return Kt}),"arrow-up":()=>Promise.resolve().then(function(){return Gt}),"bank-fill":()=>Promise.resolve().then(function(){return Yt}),"bell-slash":()=>Promise.resolve().then(function(){return el}),bell:()=>Promise.resolve().then(function(){return ll}),"bi-funnel":()=>Promise.resolve().then(function(){return ol}),"bookmark-fill":()=>Promise.resolve().then(function(){return il}),bookmark:()=>Promise.resolve().then(function(){return sl}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return hl}),"box-seam":()=>Promise.resolve().then(function(){return vl}),building:()=>Promise.resolve().then(function(){return gl}),bus:()=>Promise.resolve().then(function(){return fl}),calculator:()=>Promise.resolve().then(function(){return ml}),"calendar-check":()=>Promise.resolve().then(function(){return bl}),"calendar-heart":()=>Promise.resolve().then(function(){return xl}),"calendar-x":()=>Promise.resolve().then(function(){return Ml}),calendar:()=>Promise.resolve().then(function(){return Pl}),camera:()=>Promise.resolve().then(function(){return Vl}),car:()=>Promise.resolve().then(function(){return $l}),"chat-dots":()=>Promise.resolve().then(function(){return Bl}),"chat-left-text":()=>Promise.resolve().then(function(){return Sl}),chat:()=>Promise.resolve().then(function(){return kl}),"check-circle-fill":()=>Promise.resolve().then(function(){return El}),"check-circle":()=>Promise.resolve().then(function(){return Tl}),check:()=>Promise.resolve().then(function(){return Il}),"chevron-down":()=>Promise.resolve().then(function(){return Rl}),"chevron-left":()=>Promise.resolve().then(function(){return ql}),"chevron-right":()=>Promise.resolve().then(function(){return Kl}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return Gl}),"chevron-up":()=>Promise.resolve().then(function(){return Yl}),clock:()=>Promise.resolve().then(function(){return er}),"cloud-check":()=>Promise.resolve().then(function(){return lr}),"cloud-download":()=>Promise.resolve().then(function(){return or}),"cloud-upload":()=>Promise.resolve().then(function(){return ir}),cloud:()=>Promise.resolve().then(function(){return sr}),"code-square":()=>Promise.resolve().then(function(){return hr}),"coins-hand":()=>Promise.resolve().then(function(){return vr}),compass:()=>Promise.resolve().then(function(){return gr}),copy:()=>Promise.resolve().then(function(){return fr}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return mr}),cross:()=>Promise.resolve().then(function(){return br}),"cursor-fill":()=>Promise.resolve().then(function(){return xr}),cursor:()=>Promise.resolve().then(function(){return Mr}),"dash-circle":()=>Promise.resolve().then(function(){return Pr}),"dash-square":()=>Promise.resolve().then(function(){return Vr}),dash:()=>Promise.resolve().then(function(){return $r}),database:()=>Promise.resolve().then(function(){return Br}),dataflow:()=>Promise.resolve().then(function(){return Sr}),download:()=>Promise.resolve().then(function(){return kr}),edit:()=>Promise.resolve().then(function(){return Er}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return Tr}),"exclamation-circle":()=>Promise.resolve().then(function(){return Ir}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return Rr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return qr}),exclamation:()=>Promise.resolve().then(function(){return Kr}),"eye-fill":()=>Promise.resolve().then(function(){return Gr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Yr}),"eye-slash":()=>Promise.resolve().then(function(){return eo}),eye:()=>Promise.resolve().then(function(){return lo}),"face-smile-fill":()=>Promise.resolve().then(function(){return oo}),"face-smile":()=>Promise.resolve().then(function(){return io}),facebook:()=>Promise.resolve().then(function(){return so}),"file-earmark-text":()=>Promise.resolve().then(function(){return ho}),"file-pdf":()=>Promise.resolve().then(function(){return uo}),"file-plus":()=>Promise.resolve().then(function(){return po}),"file-text":()=>Promise.resolve().then(function(){return wo}),file:()=>Promise.resolve().then(function(){return _o}),files:()=>Promise.resolve().then(function(){return Zo}),fingerprint:()=>Promise.resolve().then(function(){return Co}),flash:()=>Promise.resolve().then(function(){return yo}),"folder-check":()=>Promise.resolve().then(function(){return Ho}),"folder-minus":()=>Promise.resolve().then(function(){return zo}),"folder-plus":()=>Promise.resolve().then(function(){return Oo}),folder:()=>Promise.resolve().then(function(){return jo}),gear:()=>Promise.resolve().then(function(){return Lo}),"geo-alt":()=>Promise.resolve().then(function(){return Ao}),"geo-fill":()=>Promise.resolve().then(function(){return No}),geo:()=>Promise.resolve().then(function(){return Uo}),"globe-alt":()=>Promise.resolve().then(function(){return Do}),globe:()=>Promise.resolve().then(function(){return Wo}),google:()=>Promise.resolve().then(function(){return Fo}),"grid-alt":()=>Promise.resolve().then(function(){return Jo}),"grid-fill":()=>Promise.resolve().then(function(){return Xo}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return Qo}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return tn}),"hard-drive":()=>Promise.resolve().then(function(){return rn}),heart:()=>Promise.resolve().then(function(){return nn}),"house-door":()=>Promise.resolve().then(function(){return sn}),house:()=>Promise.resolve().then(function(){return hn}),image:()=>Promise.resolve().then(function(){return vn}),"in-box":()=>Promise.resolve().then(function(){return gn}),"info-circle-fill":()=>Promise.resolve().then(function(){return fn}),"info-circle":()=>Promise.resolve().then(function(){return mn}),instagram:()=>Promise.resolve().then(function(){return bn}),key:()=>Promise.resolve().then(function(){return xn}),"laptop-gear":()=>Promise.resolve().then(function(){return Mn}),laptop:()=>Promise.resolve().then(function(){return Pn}),layers:()=>Promise.resolve().then(function(){return Vn}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return $n}),"layout-text-window":()=>Promise.resolve().then(function(){return Bn}),layout:()=>Promise.resolve().then(function(){return Sn}),"life-buoy":()=>Promise.resolve().then(function(){return kn}),lightbulb:()=>Promise.resolve().then(function(){return En}),link:()=>Promise.resolve().then(function(){return Tn}),linkedin:()=>Promise.resolve().then(function(){return In}),list:()=>Promise.resolve().then(function(){return Rn}),"lock-fill":()=>Promise.resolve().then(function(){return qn}),lock:()=>Promise.resolve().then(function(){return Kn}),login:()=>Promise.resolve().then(function(){return Gn}),logout:()=>Promise.resolve().then(function(){return Yn}),luggage:()=>Promise.resolve().then(function(){return ei}),"mail-open":()=>Promise.resolve().then(function(){return li}),mail:()=>Promise.resolve().then(function(){return oi}),map:()=>Promise.resolve().then(function(){return ii}),meetup:()=>Promise.resolve().then(function(){return si}),menu:()=>Promise.resolve().then(function(){return hi}),microphone:()=>Promise.resolve().then(function(){return vi}),monitor:()=>Promise.resolve().then(function(){return gi}),moon:()=>Promise.resolve().then(function(){return fi}),move:()=>Promise.resolve().then(function(){return mi}),paperclip:()=>Promise.resolve().then(function(){return bi}),passcode:()=>Promise.resolve().then(function(){return xi}),passport:()=>Promise.resolve().then(function(){return Mi}),pause:()=>Promise.resolve().then(function(){return Pi}),pencil:()=>Promise.resolve().then(function(){return Vi}),"pending-circle":()=>Promise.resolve().then(function(){return $i}),"person-dash":()=>Promise.resolve().then(function(){return Bi}),"person-plus":()=>Promise.resolve().then(function(){return Si}),"person-x":()=>Promise.resolve().then(function(){return ki}),person:()=>Promise.resolve().then(function(){return Ei}),phone:()=>Promise.resolve().then(function(){return Ti}),"pin-map-fill":()=>Promise.resolve().then(function(){return Ii}),pin:()=>Promise.resolve().then(function(){return Ri}),placeholder:()=>Promise.resolve().then(function(){return qi}),plane:()=>Promise.resolve().then(function(){return Ki}),play:()=>Promise.resolve().then(function(){return Gi}),"plus-circle":()=>Promise.resolve().then(function(){return Yi}),"plus-square":()=>Promise.resolve().then(function(){return ea}),plus:()=>Promise.resolve().then(function(){return la}),printer:()=>Promise.resolve().then(function(){return oa}),"question-circle":()=>Promise.resolve().then(function(){return ia}),rocket:()=>Promise.resolve().then(function(){return sa}),save:()=>Promise.resolve().then(function(){return ha}),search:()=>Promise.resolve().then(function(){return va}),send:()=>Promise.resolve().then(function(){return ga}),"sg-crest":()=>Promise.resolve().then(function(){return fa}),share:()=>Promise.resolve().then(function(){return ma}),"shield-tick":()=>Promise.resolve().then(function(){return ba}),"sidebar-collapse":()=>Promise.resolve().then(function(){return xa}),"sidebar-expand":()=>Promise.resolve().then(function(){return Ma}),"slash-circle":()=>Promise.resolve().then(function(){return Pa}),"slash-divider":()=>Promise.resolve().then(function(){return Va}),sliders:()=>Promise.resolve().then(function(){return $a}),"sort-ascending":()=>Promise.resolve().then(function(){return Ba}),"sort-descending":()=>Promise.resolve().then(function(){return Sa}),speedometer:()=>Promise.resolve().then(function(){return ka}),"star-ai":()=>Promise.resolve().then(function(){return Ea}),"star-fill":()=>Promise.resolve().then(function(){return Ta}),star:()=>Promise.resolve().then(function(){return Ia}),stoplights:()=>Promise.resolve().then(function(){return Ra}),sun:()=>Promise.resolve().then(function(){return qa}),"switch-horizontal":()=>Promise.resolve().then(function(){return Ka}),"switch-vertical":()=>Promise.resolve().then(function(){return Ga}),tablet:()=>Promise.resolve().then(function(){return Ya}),telegram:()=>Promise.resolve().then(function(){return es}),telephone:()=>Promise.resolve().then(function(){return ls}),"three-dots-vertical":()=>Promise.resolve().then(function(){return os}),"three-dots":()=>Promise.resolve().then(function(){return is}),ticket:()=>Promise.resolve().then(function(){return ss}),"toggle-off":()=>Promise.resolve().then(function(){return hs}),"toggle-on":()=>Promise.resolve().then(function(){return vs}),train:()=>Promise.resolve().then(function(){return gs}),translate:()=>Promise.resolve().then(function(){return fs}),trash:()=>Promise.resolve().then(function(){return ms}),"trend-down":()=>Promise.resolve().then(function(){return bs}),"trend-up":()=>Promise.resolve().then(function(){return xs}),truck:()=>Promise.resolve().then(function(){return Ms}),"twitter-x":()=>Promise.resolve().then(function(){return Ps}),unlock:()=>Promise.resolve().then(function(){return Vs}),upload:()=>Promise.resolve().then(function(){return $s}),"user-check":()=>Promise.resolve().then(function(){return Bs}),"user-circle":()=>Promise.resolve().then(function(){return Ss}),"user-pause":()=>Promise.resolve().then(function(){return ks}),"user-square":()=>Promise.resolve().then(function(){return Es}),users:()=>Promise.resolve().then(function(){return Ts}),"video-recorder":()=>Promise.resolve().then(function(){return Is}),"volume-max":()=>Promise.resolve().then(function(){return Rs}),"volume-x":()=>Promise.resolve().then(function(){return qs}),"window-dash":()=>Promise.resolve().then(function(){return Ks}),"window-desktop":()=>Promise.resolve().then(function(){return Gs}),"window-dock":()=>Promise.resolve().then(function(){return Ys}),"window-fullscreen":()=>Promise.resolve().then(function(){return ec}),"window-plus":()=>Promise.resolve().then(function(){return lc}),"window-sidebar":()=>Promise.resolve().then(function(){return oc}),"window-split":()=>Promise.resolve().then(function(){return ic}),"window-stack":()=>Promise.resolve().then(function(){return sc}),"window-x":()=>Promise.resolve().then(function(){return hc}),window:()=>Promise.resolve().then(function(){return vc}),"xcircle-fill":()=>Promise.resolve().then(function(){return gc}),xcircle:()=>Promise.resolve().then(function(){return fc}),youtube:()=>Promise.resolve().then(function(){return mc}),"zoom-in":()=>Promise.resolve().then(function(){return bc}),"zoom-out":()=>Promise.resolve().then(function(){return xc})};var Qe=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sgds-icon-size-xs);width:var(--sgds-icon-size-xs)}:host([size=sm]) svg{height:var(--sgds-icon-size-sm);width:var(--sgds-icon-size-sm)}:host([size=md]) svg{height:var(--sgds-icon-size-md);width:var(--sgds-icon-size-md)}:host([size=xl]) svg{height:var(--sgds-icon-size-xl);width:var(--sgds-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sgds-icon-size-2-xl);width:var(--sgds-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sgds-icon-size-3-xl);width:var(--sgds-icon-size-3-xl)}svg{display:inline-block;height:var(--sgds-icon-size-lg);width:var(--sgds-icon-size-lg)}`;const et=new Map;class tt extends Oe{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(et.has(e))return void(this._icon=et.get(e));const t=Ye[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();et.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:le}}tt.styles=[...Oe.styles,Qe],e([Pe({type:String,reflect:!0})],tt.prototype,"name",void 0),e([Pe({type:String,reflect:!0})],tt.prototype,"size",void 0),e([Pe({type:String})],tt.prototype,"ariaLabel",void 0),e([He()],tt.prototype,"_icon",void 0);var lt=i`:host{--sgds-spinner-bg:var(--sgds-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sgds-spinner-bg:var(--sgds-neutral-surface-default)}:host([tone=neutral]){--sgds-spinner-bg:var(--sgds-surface-inverse)}:host([tone=inverse]){--sgds-spinner-bg:var(--sgds-surface-default)}:host([tone=fixed-light]){--sgds-spinner-bg:var(--sgds-surface-fixed-light)}:host([tone=fixed-dark]){--sgds-spinner-bg:var(--sgds-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sgds-gap-2-xs)}.spinner-wrapper.horizontal{flex-direction:row}.spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sgds-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sgds-spinner-bg);color:var(--sgds-spinner-color);display:inline-flex;height:var(--sgds-dimension-32);width:var(--sgds-dimension-32)}.spinner-xs{--border-thickness:2px;height:var(--sgds-dimension-16);width:var(--sgds-dimension-16)}.spinner-sm{--border-thickness:3px;height:var(--sgds-dimension-24);width:var(--sgds-dimension-24)}.spinner-lg{--border-thickness:6px;height:var(--sgds-dimension-48);width:var(--sgds-dimension-48)}.spinner-xl{--border-thickness:8px;height:var(--sgds-dimension-64);width:var(--sgds-dimension-64)}.spinner-label{color:var(--sgds-neutral-color-default);font-size:var(--sgds-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,rt=i`.text-primary{color:var(--sgds-primary-rgb)!important}.text-secondary{color:var(--sgds-secondary-rgb)!important}.text-success{color:var(--sgds-success-rgb)!important}.text-info{color:var(--sgds-info-rgb)!important}.text-warning{color:var(--sgds-warning-rgb)!important}.text-danger{color:var(--sgds-danger-rgb)!important}.text-light{color:var(--sgds-light-rgb)!important}.text-dark{color:var(--sgds-dark-rgb)!important}.text-muted{color:var(--sgds-secondary-color)!important}`;class ot extends Oe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Ue`
      <div
    ...
    `}}ot.styles=[...Oe.styles,rt,lt],e([Pe({type:String,reflect:!0})],ot.prototype,"variant",void 0),e([Pe({type:String,reflect:!0})],ot.prototype,"tone",void 0),e([Pe({type:String,reflect:!0})],ot.prototype,"size",void 0),e([Pe({reflect:!0,type:String})],ot.prototype,"label",void 0),e([Pe({type:String,reflect:!0})],ot.prototype,"orientation",void 0);var nt=i`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sgds-dimension-48,56px);min-width:unset;padding:0;width:var(--sgds-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sgds-dimension-56);min-width:unset;padding:0;width:var(--sgds-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sgds-dimension-40);min-width:unset;padding:0;width:var(--sgds-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sgds-dimension-32);min-width:unset;padding:0;width:var(--sgds-dimension-32)}`;class it extends qe{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?Ne`a`:Ne`button`;return Ue`
          <${t}
  ...
  `,this._renderFirstEllipsis=()=>this.pages.length<=7||!(this.pages.length!==this._limit&&this.currentPage>4)?null:Q`
    ...
    `,this._getNavButton=(e,t,l)=>{const r=Q`<sgds-icon
      size=${this.size}
    ...
    `}_renderDirectionButton(e,t){const l=this.currentPage===this.pages.length||this.pages.length<=1,r=1===this.currentPage,o="Prev"===e?r:l;return"button"===this.navigation?Q`${this._getNavButton(e,t,o)}`:"icon-button"===this.navigation?Q`${this._getIconButton(e,t,o)}`:Q`${le}`}_getIconButton(e,t,l){return Q`
      <sgds-icon-button
        tone="neutral"
        ariaLabel=${"Prev"===e?"Previous":"Next"}
        size=${this.size}
    ...
    `}}ht.styles=[...Oe.styles,ct],ht.dependencies={"sgds-icon-button":it,"sgds-button":Xe,"sgds-icon":tt},e([Pe({type:Number})],ht.prototype,"dataLength",void 0),e([Pe({type:Number})],ht.prototype,"currentPage",void 0),e([Pe({type:Number})],ht.prototype,"itemsPerPage",void 0),e([Pe({type:String})],ht.prototype,"variant",void 0),e([Pe({type:String})],ht.prototype,"navigation",void 0),e([Pe({type:String})],ht.prototype,"size",void 0),e([He()],ht.prototype,"_limit",void 0),e([function(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,r)=>{const{update:o}=t;if(e in t){const n=e;t.update=function(e){if(e.has(n)){const t=e.get(n),o=this[n];t!==o&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[r](t,o))}o.call(this,e)}}}}("currentPage",{waitUntilFirstUpdate:!1})],ht.prototype,"_handleValueChange",null),at="sgds-pagination",st=ht,customElements.get(at)||customElements.define(at,st);var dt=Q`
...
`,gt=Object.freeze({__proto__:null,default:ut}),pt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gl=Object.freeze({__proto__:null,default:ul}),pl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gr=Object.freeze({__proto__:null,default:ur}),pr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,uo=Object.freeze({__proto__:null,default:vo}),go=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gn=Object.freeze({__proto__:null,default:un}),pn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gi=Object.freeze({__proto__:null,default:ui}),pi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ga=Object.freeze({__proto__:null,default:ua}),pa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,gs=Object.freeze({__proto__:null,default:us}),ps=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ps=Object.freeze({__proto__:null,default:ys}),Hs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vs=Object.freeze({__proto__:null,default:Hs}),zs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$s=Object.freeze({__proto__:null,default:zs}),Os=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bs=Object.freeze({__proto__:null,default:Os}),js=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ss=Object.freeze({__proto__:null,default:js}),Ls=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ks=Object.freeze({__proto__:null,default:Ls}),As=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Es=Object.freeze({__proto__:null,default:As}),Ns=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ts=Object.freeze({__proto__:null,default:Ns}),Us=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Is=Object.freeze({__proto__:null,default:Us}),Ds=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rs=Object.freeze({__proto__:null,default:Ds}),Ws=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ks=Object.freeze({__proto__:null,default:Fs}),Js=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Gs=Object.freeze({__proto__:null,default:Js}),Xs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gc=Object.freeze({__proto__:null,default:uc}),pc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xc=Object.freeze({__proto__:null,default:Zc})});
