...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */let ze;function Oe(e,t){return(l,r,o)=>{const n=l=>{const o=l.renderRoot?.querySelector(e)??null;if(null===o&&t&&!l.hasUpdated){const t="object"==typeof r?r.name:r;ze("",`@query'd field ${JSON.stringify(String(t))} with the 'cache' flag set for selector '${e}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return o};if(t){const{get:e,set:t}="object"==typeof r?l:o??(()=>{const e=Symbol(`${String(r)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Pe(l,r,{get(){let l=e.call(this);return void 0===l&&(l=n(this),(null!==l||this.hasUpdated)&&t.call(this,l)),l}})}return Pe(l,r,{get(){return n(this)}})}}
/**
   * @license
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */const $e=(Se=class extends Be{constructor(e){if(super(e),e.type!==je||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const r=!!t[e];r===this._previousClasses.has(e)||this._staticClasses?.has(e)||(r?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return te}},(...e)=>({_$litDirective$:Se,values:e}));var Se,Ae=i`:host{-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-font-smoothing:antialiased;color:var(--sgds-body-color-default,#1a1a1a);display:block;font-family:var(--sgds-font-family-brand,"Inter",system-ui,sans-serif);font-size:var(--sgds-font-size-body-md,1rem);font-weight:var(--sgds-font-weight-regular,400);line-height:var(--sgds-line-height-xs,24px);margin:0;*,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}:disabled{cursor:not-allowed}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}::slotted(svg){vertical-align:middle}}`;class ke extends be{emit(e,t){const l=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(l),l}static define(e,t=this,l={}){if(customElements.get(e));else try{customElements.define(e,t,l)}catch(r){customElements.define(e,class extends t{},l)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}ke.styles=[Ae],ke.dependencies={},e([Ve({type:Boolean,reflect:!0})],ke.prototype,"ssr",void 0);var Le=i`:host{--sgds-close-btn-border-radius:var(--sgds-border-radius-sm);display:inline-flex}:host([size=sm]) .btn-close{height:var(--sgds-dimension-24);width:var(--sgds-dimension-24)}:host([tone=fixed-light]) .btn-close{color:var(--sgds-color-fixed-light)}:host([tone=fixed-dark]) .btn-close{color:var(--sgds-color-fixed-dark)}.btn-close{align-items:center;background-color:var(--sgds-bg-transparent);border:0;border:var(--sgds-border-width-1) solid var(--sgds-border-color-transparent);border-radius:var(--sgds-close-btn-border-radius);cursor:pointer;display:flex;height:var(--sgds-dimension-32);justify-content:center;padding:0;position:relative;width:var(--sgds-dimension-32)}.btn-close:focus-visible,.btn-close:hover{background-color:var(--sgds-bg-translucent)}:host([tone=fixed-light]) .btn-close:focus-visible,:host([tone=fixed-light]) .btn-close:hover{background-color:var(--sgds-bg-translucent-fixed-light)}:host([tone=fixed-dark]) .btn-close:focus-visible,:host([tone=fixed-dark]) .btn-close:hover{background-color:var(--sgds-bg-translucent-fixed-dark)}.btn-close:focus-visible{outline:var(--sgds-outline-focus);outline-offset:var(--sgds-outline-offset-focus)}:host([disabled]) .btn-close{cursor:not-allowed;opacity:var(--sgds-opacity-40);pointer-events:none}`;function Ee(e){return!!function(e){return!!customElements.get(e)}(e)||(console.error(`Custom element of name : ${e} is not registered. Remember to import the component file for custom element registration`),!1)}class Te extends ke{constructor(){super(...arguments),this.size="md",this.tone="default",this.disabled=!1,this._clickHandler=()=>{}}_handleClick(e){if(this.disabled)return e.preventDefault(),void e.stopPropagation();this.removeEventListener("click",this._clickHandler),this.addEventListener("click",this._clickHandler)}firstUpdated(e){super.firstUpdated(e),Ee("sgds-icon")}render(){return Q`
    ...
    `}}function Ne(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}Te.styles=[...ke.styles,Le],e([Ve({type:String,reflect:!0})],Te.prototype,"size",void 0),e([Ve({type:String,reflect:!0})],Te.prototype,"tone",void 0),e([Ve({type:Boolean,reflect:!0})],Te.prototype,"disabled",void 0);const Ie=new Map,Ue=new WeakMap;function Re(e,t){Ie.set(e,function(e){return null!=e?e:{keyframes:[],options:{duration:0}}}(t))}const De={announcement:()=>Promise.resolve().then(function(){return Mt}),archive:()=>Promise.resolve().then(function(){return Vt}),"arrow-bar-down":()=>Promise.resolve().then(function(){return Pt}),"arrow-bar-left":()=>Promise.resolve().then(function(){return Ot}),"arrow-bar-right":()=>Promise.resolve().then(function(){return Bt}),"arrow-bar-up":()=>Promise.resolve().then(function(){return St}),"arrow-circle-down":()=>Promise.resolve().then(function(){return kt}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Et}),"arrow-circle-right":()=>Promise.resolve().then(function(){return Nt}),"arrow-circle-up":()=>Promise.resolve().then(function(){return Ut}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Dt}),"arrow-down":()=>Promise.resolve().then(function(){return Wt}),"arrow-left":()=>Promise.resolve().then(function(){return Yt}),"arrow-repeat":()=>Promise.resolve().then(function(){return Kt}),"arrow-right":()=>Promise.resolve().then(function(){return Gt}),"arrow-square-down":()=>Promise.resolve().then(function(){return el}),"arrow-square-left":()=>Promise.resolve().then(function(){return ll}),"arrow-square-right":()=>Promise.resolve().then(function(){return ol}),"arrow-square-up":()=>Promise.resolve().then(function(){return il}),"arrow-up":()=>Promise.resolve().then(function(){return sl}),"bank-fill":()=>Promise.resolve().then(function(){return hl}),"bell-slash":()=>Promise.resolve().then(function(){return vl}),bell:()=>Promise.resolve().then(function(){return pl}),"bi-funnel":()=>Promise.resolve().then(function(){return fl}),"bookmark-fill":()=>Promise.resolve().then(function(){return ml}),bookmark:()=>Promise.resolve().then(function(){return bl}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return xl}),"box-seam":()=>Promise.resolve().then(function(){return Ml}),building:()=>Promise.resolve().then(function(){return Vl}),bus:()=>Promise.resolve().then(function(){return Pl}),calculator:()=>Promise.resolve().then(function(){return Ol}),"calendar-check":()=>Promise.resolve().then(function(){return Bl}),"calendar-heart":()=>Promise.resolve().then(function(){return Sl}),"calendar-x":()=>Promise.resolve().then(function(){return kl}),calendar:()=>Promise.resolve().then(function(){return El}),camera:()=>Promise.resolve().then(function(){return Nl}),car:()=>Promise.resolve().then(function(){return Ul}),"chat-dots":()=>Promise.resolve().then(function(){return Dl}),"chat-left-text":()=>Promise.resolve().then(function(){return Wl}),chat:()=>Promise.resolve().then(function(){return Yl}),"check-circle-fill":()=>Promise.resolve().then(function(){return Kl}),"check-circle":()=>Promise.resolve().then(function(){return Gl}),check:()=>Promise.resolve().then(function(){return er}),"chevron-down":()=>Promise.resolve().then(function(){return lr}),"chevron-left":()=>Promise.resolve().then(function(){return or}),"chevron-right":()=>Promise.resolve().then(function(){return ir}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return sr}),"chevron-up":()=>Promise.resolve().then(function(){return hr}),clock:()=>Promise.resolve().then(function(){return vr}),"cloud-check":()=>Promise.resolve().then(function(){return pr}),"cloud-download":()=>Promise.resolve().then(function(){return fr}),"cloud-upload":()=>Promise.resolve().then(function(){return mr}),cloud:()=>Promise.resolve().then(function(){return br}),"code-square":()=>Promise.resolve().then(function(){return xr}),"coins-hand":()=>Promise.resolve().then(function(){return Mr}),compass:()=>Promise.resolve().then(function(){return Vr}),copy:()=>Promise.resolve().then(function(){return Pr}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Or}),cross:()=>Promise.resolve().then(function(){return Br}),"cursor-fill":()=>Promise.resolve().then(function(){return Sr}),cursor:()=>Promise.resolve().then(function(){return kr}),"dash-circle":()=>Promise.resolve().then(function(){return Er}),"dash-square":()=>Promise.resolve().then(function(){return Nr}),dash:()=>Promise.resolve().then(function(){return Ur}),database:()=>Promise.resolve().then(function(){return Dr}),dataflow:()=>Promise.resolve().then(function(){return Wr}),download:()=>Promise.resolve().then(function(){return Yr}),edit:()=>Promise.resolve().then(function(){return Kr}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return Gr}),"exclamation-circle":()=>Promise.resolve().then(function(){return eo}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return lo}),"exclamation-triangle":()=>Promise.resolve().then(function(){return oo}),exclamation:()=>Promise.resolve().then(function(){return io}),"eye-fill":()=>Promise.resolve().then(function(){return so}),"eye-slash-fill":()=>Promise.resolve().then(function(){return ho}),"eye-slash":()=>Promise.resolve().then(function(){return uo}),eye:()=>Promise.resolve().then(function(){return go}),"face-smile-fill":()=>Promise.resolve().then(function(){return wo}),"face-smile":()=>Promise.resolve().then(function(){return _o}),facebook:()=>Promise.resolve().then(function(){return Zo}),"file-earmark-text":()=>Promise.resolve().then(function(){return Co}),"file-pdf":()=>Promise.resolve().then(function(){return yo}),"file-plus":()=>Promise.resolve().then(function(){return Ho}),"file-text":()=>Promise.resolve().then(function(){return zo}),file:()=>Promise.resolve().then(function(){return jo}),files:()=>Promise.resolve().then(function(){return $o}),fingerprint:()=>Promise.resolve().then(function(){return Ao}),flash:()=>Promise.resolve().then(function(){return Lo}),"folder-check":()=>Promise.resolve().then(function(){return To}),"folder-minus":()=>Promise.resolve().then(function(){return Io}),"folder-plus":()=>Promise.resolve().then(function(){return Ro}),folder:()=>Promise.resolve().then(function(){return qo}),gear:()=>Promise.resolve().then(function(){return Fo}),"geo-alt":()=>Promise.resolve().then(function(){return Jo}),"geo-fill":()=>Promise.resolve().then(function(){return Xo}),geo:()=>Promise.resolve().then(function(){return Qo}),"globe-alt":()=>Promise.resolve().then(function(){return tn}),globe:()=>Promise.resolve().then(function(){return rn}),google:()=>Promise.resolve().then(function(){return nn}),"grid-alt":()=>Promise.resolve().then(function(){return sn}),"grid-fill":()=>Promise.resolve().then(function(){return hn}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return vn}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return pn}),"hard-drive":()=>Promise.resolve().then(function(){return fn}),heart:()=>Promise.resolve().then(function(){return mn}),"house-door":()=>Promise.resolve().then(function(){return bn}),house:()=>Promise.resolve().then(function(){return xn}),image:()=>Promise.resolve().then(function(){return Mn}),"in-box":()=>Promise.resolve().then(function(){return Vn}),"info-circle-fill":()=>Promise.resolve().then(function(){return Pn}),"info-circle":()=>Promise.resolve().then(function(){return On}),instagram:()=>Promise.resolve().then(function(){return Bn}),key:()=>Promise.resolve().then(function(){return Sn}),"laptop-gear":()=>Promise.resolve().then(function(){return kn}),laptop:()=>Promise.resolve().then(function(){return En}),layers:()=>Promise.resolve().then(function(){return Nn}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Un}),"layout-text-window":()=>Promise.resolve().then(function(){return Dn}),layout:()=>Promise.resolve().then(function(){return Wn}),"life-buoy":()=>Promise.resolve().then(function(){return Yn}),lightbulb:()=>Promise.resolve().then(function(){return Kn}),link:()=>Promise.resolve().then(function(){return Gn}),linkedin:()=>Promise.resolve().then(function(){return ei}),list:()=>Promise.resolve().then(function(){return li}),"lock-fill":()=>Promise.resolve().then(function(){return oi}),lock:()=>Promise.resolve().then(function(){return ii}),login:()=>Promise.resolve().then(function(){return si}),logout:()=>Promise.resolve().then(function(){return hi}),luggage:()=>Promise.resolve().then(function(){return vi}),"mail-open":()=>Promise.resolve().then(function(){return pi}),mail:()=>Promise.resolve().then(function(){return fi}),map:()=>Promise.resolve().then(function(){return mi}),meetup:()=>Promise.resolve().then(function(){return bi}),menu:()=>Promise.resolve().then(function(){return xi}),microphone:()=>Promise.resolve().then(function(){return Mi}),monitor:()=>Promise.resolve().then(function(){return Vi}),moon:()=>Promise.resolve().then(function(){return Pi}),move:()=>Promise.resolve().then(function(){return Oi}),paperclip:()=>Promise.resolve().then(function(){return Bi}),passcode:()=>Promise.resolve().then(function(){return Si}),passport:()=>Promise.resolve().then(function(){return ki}),pause:()=>Promise.resolve().then(function(){return Ei}),pencil:()=>Promise.resolve().then(function(){return Ni}),"pending-circle":()=>Promise.resolve().then(function(){return Ui}),"person-dash":()=>Promise.resolve().then(function(){return Di}),"person-plus":()=>Promise.resolve().then(function(){return Wi}),"person-x":()=>Promise.resolve().then(function(){return Yi}),person:()=>Promise.resolve().then(function(){return Ki}),phone:()=>Promise.resolve().then(function(){return Gi}),"pin-map-fill":()=>Promise.resolve().then(function(){return ea}),pin:()=>Promise.resolve().then(function(){return la}),placeholder:()=>Promise.resolve().then(function(){return oa}),plane:()=>Promise.resolve().then(function(){return ia}),play:()=>Promise.resolve().then(function(){return sa}),"plus-circle":()=>Promise.resolve().then(function(){return ha}),"plus-square":()=>Promise.resolve().then(function(){return va}),plus:()=>Promise.resolve().then(function(){return pa}),printer:()=>Promise.resolve().then(function(){return fa}),"question-circle":()=>Promise.resolve().then(function(){return ma}),rocket:()=>Promise.resolve().then(function(){return ba}),save:()=>Promise.resolve().then(function(){return xa}),search:()=>Promise.resolve().then(function(){return Ma}),send:()=>Promise.resolve().then(function(){return Va}),"sg-crest":()=>Promise.resolve().then(function(){return Pa}),share:()=>Promise.resolve().then(function(){return Oa}),"shield-tick":()=>Promise.resolve().then(function(){return Ba}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Sa}),"sidebar-expand":()=>Promise.resolve().then(function(){return ka}),"slash-circle":()=>Promise.resolve().then(function(){return Ea}),"slash-divider":()=>Promise.resolve().then(function(){return Na}),sliders:()=>Promise.resolve().then(function(){return Ua}),"sort-ascending":()=>Promise.resolve().then(function(){return Da}),"sort-descending":()=>Promise.resolve().then(function(){return Wa}),speedometer:()=>Promise.resolve().then(function(){return Ya}),"star-ai":()=>Promise.resolve().then(function(){return Ka}),"star-fill":()=>Promise.resolve().then(function(){return Ga}),star:()=>Promise.resolve().then(function(){return es}),stoplights:()=>Promise.resolve().then(function(){return ls}),sun:()=>Promise.resolve().then(function(){return os}),"switch-horizontal":()=>Promise.resolve().then(function(){return is}),"switch-vertical":()=>Promise.resolve().then(function(){return ss}),tablet:()=>Promise.resolve().then(function(){return hs}),telegram:()=>Promise.resolve().then(function(){return vs}),telephone:()=>Promise.resolve().then(function(){return ps}),"three-dots-vertical":()=>Promise.resolve().then(function(){return fs}),"three-dots":()=>Promise.resolve().then(function(){return ms}),ticket:()=>Promise.resolve().then(function(){return bs}),"toggle-off":()=>Promise.resolve().then(function(){return xs}),"toggle-on":()=>Promise.resolve().then(function(){return Ms}),train:()=>Promise.resolve().then(function(){return Vs}),translate:()=>Promise.resolve().then(function(){return Ps}),trash:()=>Promise.resolve().then(function(){return Os}),"trend-down":()=>Promise.resolve().then(function(){return Bs}),"trend-up":()=>Promise.resolve().then(function(){return Ss}),truck:()=>Promise.resolve().then(function(){return ks}),"twitter-x":()=>Promise.resolve().then(function(){return Es}),unlock:()=>Promise.resolve().then(function(){return Ns}),upload:()=>Promise.resolve().then(function(){return Us}),"user-check":()=>Promise.resolve().then(function(){return Ds}),"user-circle":()=>Promise.resolve().then(function(){return Ws}),"user-pause":()=>Promise.resolve().then(function(){return Ys}),"user-square":()=>Promise.resolve().then(function(){return Ks}),users:()=>Promise.resolve().then(function(){return Gs}),"video-recorder":()=>Promise.resolve().then(function(){return ec}),"volume-max":()=>Promise.resolve().then(function(){return lc}),"volume-x":()=>Promise.resolve().then(function(){return oc}),"window-dash":()=>Promise.resolve().then(function(){return ic}),"window-desktop":()=>Promise.resolve().then(function(){return sc}),"window-dock":()=>Promise.resolve().then(function(){return hc}),"window-fullscreen":()=>Promise.resolve().then(function(){return vc}),"window-plus":()=>Promise.resolve().then(function(){return pc}),"window-sidebar":()=>Promise.resolve().then(function(){return fc}),"window-split":()=>Promise.resolve().then(function(){return mc}),"window-stack":()=>Promise.resolve().then(function(){return bc}),"window-x":()=>Promise.resolve().then(function(){return xc}),window:()=>Promise.resolve().then(function(){return Mc}),"xcircle-fill":()=>Promise.resolve().then(function(){return Vc}),xcircle:()=>Promise.resolve().then(function(){return Pc}),youtube:()=>Promise.resolve().then(function(){return Oc}),"zoom-in":()=>Promise.resolve().then(function(){return Bc}),"zoom-out":()=>Promise.resolve().then(function(){return Sc})};var qe=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sgds-icon-size-xs);width:var(--sgds-icon-size-xs)}:host([size=sm]) svg{height:var(--sgds-icon-size-sm);width:var(--sgds-icon-size-sm)}:host([size=md]) svg{height:var(--sgds-icon-size-md);width:var(--sgds-icon-size-md)}:host([size=xl]) svg{height:var(--sgds-icon-size-xl);width:var(--sgds-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sgds-icon-size-2-xl);width:var(--sgds-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sgds-icon-size-3-xl);width:var(--sgds-icon-size-3-xl)}svg{display:inline-block;height:var(--sgds-icon-size-lg);width:var(--sgds-icon-size-lg)}`;const We=new Map;class Fe extends ke{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(We.has(e))return void(this._icon=We.get(e));const t=De[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();We.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:le}}Fe.styles=[...ke.styles,qe],e([Ve({type:String,reflect:!0})],Fe.prototype,"name",void 0),e([Ve({type:String,reflect:!0})],Fe.prototype,"size",void 0),e([Ve({type:String})],Fe.prototype,"ariaLabel",void 0),e([He()],Fe.prototype,"_icon",void 0);
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Ye=e=>e??le,Je=Symbol.for(""),Ke=e=>{if(e?.r===Je)return e?._$litStatic$},Xe=(e,...t)=>({_$litStatic$:t.reduce((t,l,r)=>t+(e=>{if(void 0!==e._$litStatic$)return e._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(l)+e[r+1],e[0]),r:Je}),Ge=new Map,Qe=(et=Q,(e,...t)=>{const l=t.length;let r,o;const n=[],i=[];let a,s=0,c=!1;for(;s<l;){for(a=e[s];s<l&&void 0!==(o=t[s],r=Ke(o));)a+=r+e[++s],c=!0;s!==l&&i.push(o),n.push(a),s++}if(s===l&&n.push(e[l]),c){const l=n.join("$$lit$$");void 0===(e=Ge.get(l))&&(n.raw=n,Ge.set(l,e=n)),t=i}return et(e,...t)});
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */var et,tt=i`:host{--btn-font-weight:var(--sgds-font-weight-regular);--btn-color:var(--sgds-color-fixed-light);--btn-bg:var(--sgds-primary-surface-default);--btn-hover-bg:var(--sgds-primary-surface-emphasis);--btn-border-radius:var(--sgds-border-radius-md);--btn-opacity:var(--sgds-opacity-100,1)}:host([variant=danger]){--btn-bg:var(--sgds-danger-surface-default);--btn-hover-bg:var(--sgds-danger-surface-emphasis);--btn-color:var(--sgds-color-fixed-light)}:host([variant=primary][tone=brand]){--btn-bg:var(--sgds-primary-surface-default);--btn-color:var(--sgds-color-fixed-light)}:host([variant=outline]){--btn-border-width:var(--sgds-border-width-1)}:host([variant=outline][tone=brand]){--btn-border-color:var(--sgds-primary-border-color-default);--btn-bg:var(--sgds-bg-transparent);--btn-color:var(--sgds-primary-color-default);--btn-hover-bg:var(--sgds-primary-bg-translucent)}:host([variant=ghost][tone=brand]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-primary-surface-translucent);--btn-color:var(--sgds-primary-color-default)}:host([variant=primary][tone=danger]){--btn-bg:var(--sgds-danger-surface-default);--btn-hover-bg:var(--sgds-danger-surface-emphasis);--btn-color:var(--sgds-color-fixed-light)}:host([variant=outline][tone=danger]){--btn-border-color:var(--sgds-danger-border-color-default);--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-danger-surface-translucent);--btn-color:var(--sgds-danger-color-default)}:host([variant=ghost][tone=danger]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-danger-surface-translucent);--btn-color:var(--sgds-danger-color-default)}:host([variant=primary][tone=fixed-light]){--btn-bg:var(--sgds-surface-fixed-light);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 0%,var(--sgds-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 100%),var(--sgds-surface-fixed-light,#fff);--btn-color:var(--sgds-color-fixed-dark)}:host([variant=outline][tone=fixed-light]){--btn-border-color:var(--sgds-border-color-fixed-light);--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-fixed-dark) 0%,var(--sgds-bg-translucent-fixed-dark) 100%),var(--sgds-bg-transparent);--btn-color:var(--sgds-color-fixed-light)}:host([variant=ghost][tone=fixed-light]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-fixed-dark) 0%,var(--sgds-bg-translucent-fixed-dark) 100%),var(--sgds-bg-transparent);--btn-color:var(--sgds-color-fixed-light)}:host([variant=primary][tone=neutral]){--btn-bg:var(--sgds-surface-inverse);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-inverse) 0%,var(--sgds-bg-translucent-inverse) 100%),var(--sgds-surface-inverse);--btn-color:var(--sgds-color-inverse)}:host([variant=outline][tone=neutral]){--btn-border-color:var(--sgds-border-color-emphasis);--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sgds-bg-translucent-inverse) 0%,var(--sgds-bg-translucent-inverse) 100%),var(--sgds-bg-translucent-subtle);--btn-color:var(--sgds-color-default)}:host([variant=ghost][tone=neutral]){--btn-bg:var(--sgds-bg-transparent);--btn-hover-bg:var(--sgds-bg-translucent-subtle);--btn-color:var(--sgds-color-default)}:host([variant=ghost]) .btn,:host([variant=outline]) .btn,:host([variant=primary]) .btn{color:var(--btn-color)}:host([variant=outline]) .btn{border:var(--btn-border-width) solid var(--btn-border-color)}:host([size=lg]) .btn{font-size:var(--sgds-font-size-label-lg);height:var(--sgds-dimension-56);line-height:var(--sgds-line-height-md);min-width:var(--sgds-dimension-112);padding:var(--sgds-padding-none) var(--sgds-padding-xl)}:host([size=sm]) .btn{font-size:var(--sgds-font-size-label-sm);height:var(--sgds-dimension-40);line-height:var(--sgds-line-height-2-xs);min-width:var(--sgds-dimension-80);padding:var(--sgds-padding-none) var(--sgds-padding-md)}:host([size=xs]) .btn{font-size:var(--sgds-font-size-label-xs);height:var(--sgds-dimension-32);line-height:var(--sgds-line-height-3-xs);min-width:var(--sgds-dimension-64);padding:var(--sgds-padding-none) var(--sgds-padding-sm)}.btn{align-items:center;background-color:var(--btn-bg);border:var(--sgds-border-width-1) solid var(--sgds-border-color-transparent);border-radius:var(--btn-border-radius);color:var(--sgds-color-fixed-light);cursor:pointer;display:inline-flex;font-size:var(--sgds-font-size-label-md);font-weight:var(--btn-font-weight);gap:var(--sgds-gap-2-xs);height:var(--sgds-dimension-48);justify-content:center;line-height:var(--sgds-line-height-xs);min-width:var(--sgds-dimension-96);opacity:var(--btn-opacity);padding:var(--sgds-padding-none) var(--sgds-padding-lg);text-align:center;text-decoration:none;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;user-select:none;vertical-align:middle;white-space:nowrap;width:inherit}@media (prefers-reduced-motion:reduce){.btn{transition:none}}.btn.active,.btn:hover{background:var(--btn-hover-bg)}.btn:focus-visible{background:var(--btn-hover-bg);border-color:transparent;outline:var(--sgds-outline-focus);outline-offset:var(--sgds-outline-offset-focus)}.btn.disabled,.btn:disabled{color:var(--btn-color);cursor:not-allowed;opacity:var(--sgds-opacity-40)}.btn.loading{cursor:default}.btn slot::slotted(*){color:var(--btn-color)}`;class lt extends ke{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.active=!1,this.disabled=!1,this.target="_self"}focus(e){this.button.focus(e)}click(){this.button.click()}blur(){this.button.blur()}_handleBlur(){this.emit("sgds-blur")}_handleFocus(){this.emit("sgds-focus")}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation()}_handleKeydown(e){if("Enter"===e.key&&this.loading)return e.preventDefault(),void e.stopPropagation()}_assignSpinnerSize(e){return"xs"===e||"sm"===e?"xs":"md"===e||"lg"===e?"sm":void 0}_assignSpinnerTone(e,t){return"fixed-light"===e&&"primary"===t?"fixed-dark":"neutral"===e&&"primary"===t?"inverse":"fixed-light"===e||"primary"===t?"fixed-light":"neutral"!==e||"outline"!==t&&"ghost"!==t?"brand":"neutral"}}lt.styles=[...ke.styles,tt],e([Oe(".btn")],lt.prototype,"button",void 0),e([Ve({reflect:!0})],lt.prototype,"variant",void 0),e([Ve({reflect:!0})],lt.prototype,"tone",void 0),e([Ve({reflect:!0})],lt.prototype,"size",void 0),e([Ve({type:Boolean,reflect:!0})],lt.prototype,"active",void 0),e([Ve({type:Boolean,reflect:!0})],lt.prototype,"disabled",void 0),e([Ve({type:String,reflect:!0})],lt.prototype,"href",void 0),e([Ve({type:String,reflect:!0})],lt.prototype,"target",void 0),e([Ve({type:String,reflect:!0})],lt.prototype,"download",void 0),e([Ve({type:String})],lt.prototype,"ariaLabel",void 0),e([Ve({type:Boolean})],lt.prototype,"loading",void 0);var rt=i`:host{--sgds-spinner-bg:var(--sgds-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sgds-spinner-bg:var(--sgds-neutral-surface-default)}:host([tone=neutral]){--sgds-spinner-bg:var(--sgds-surface-inverse)}:host([tone=inverse]){--sgds-spinner-bg:var(--sgds-surface-default)}:host([tone=fixed-light]){--sgds-spinner-bg:var(--sgds-surface-fixed-light)}:host([tone=fixed-dark]){--sgds-spinner-bg:var(--sgds-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sgds-gap-2-xs)}.spinner-wrapper.horizontal{flex-direction:row}.spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sgds-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sgds-spinner-bg);color:var(--sgds-spinner-color);display:inline-flex;height:var(--sgds-dimension-32);width:var(--sgds-dimension-32)}.spinner-xs{--border-thickness:2px;height:var(--sgds-dimension-16);width:var(--sgds-dimension-16)}.spinner-sm{--border-thickness:3px;height:var(--sgds-dimension-24);width:var(--sgds-dimension-24)}.spinner-lg{--border-thickness:6px;height:var(--sgds-dimension-48);width:var(--sgds-dimension-48)}.spinner-xl{--border-thickness:8px;height:var(--sgds-dimension-64);width:var(--sgds-dimension-64)}.spinner-label{color:var(--sgds-neutral-color-default);font-size:var(--sgds-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,ot=i`.text-primary{color:var(--sgds-primary-rgb)!important}.text-secondary{color:var(--sgds-secondary-rgb)!important}.text-success{color:var(--sgds-success-rgb)!important}.text-info{color:var(--sgds-info-rgb)!important}.text-warning{color:var(--sgds-warning-rgb)!important}.text-danger{color:var(--sgds-danger-rgb)!important}.text-light{color:var(--sgds-light-rgb)!important}.text-dark{color:var(--sgds-dark-rgb)!important}.text-muted{color:var(--sgds-secondary-color)!important}`;class nt extends ke{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Qe`
      <div
    ...
    `}}nt.styles=[...ke.styles,ot,rt],e([Ve({type:String,reflect:!0})],nt.prototype,"variant",void 0),e([Ve({type:String,reflect:!0})],nt.prototype,"tone",void 0),e([Ve({type:String,reflect:!0})],nt.prototype,"size",void 0),e([Ve({reflect:!0,type:String})],nt.prototype,"label",void 0),e([Ve({type:String,reflect:!0})],nt.prototype,"orientation",void 0);var it=i`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sgds-dimension-48,56px);min-width:unset;padding:0;width:var(--sgds-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sgds-dimension-56);min-width:unset;padding:0;width:var(--sgds-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sgds-dimension-40);min-width:unset;padding:0;width:var(--sgds-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sgds-dimension-32);min-width:unset;padding:0;width:var(--sgds-dimension-32)}`;class at extends lt{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?Xe`a`:Xe`button`;return Qe`
          <${t}
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function pt({context:e}){return(t,l)=>{const r=new WeakMap;if("object"==typeof l)return{get(){return t.get.call(this)},set(e){return r.get(this).setValue(e),t.set.call(this,e)},init(t){return r.set(this,new ut(this,{context:e,initialValue:t})),t}};{t.constructor.addInitializer(t=>{r.set(t,new ut(t,{context:e}))});const o=Object.getOwnPropertyDescriptor(t,l);let n;if(void 0===o){const e=new WeakMap;n={get(){return e.get(this)},set(t){r.get(this).setValue(t),e.set(this,t)},configurable:!0,enumerable:!0}}else{const e=o.set;n={...o,set(t){r.get(this).setValue(t),e?.call(this,t)}}}return void Object.defineProperty(t,l,n)}}}
/**
   * @license
   * Copyright 2022 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function gt({context:e,subscribe:t}){return(l,r)=>{"object"==typeof r?r.addInitializer(function(){new ht(this,{context:e,callback:e=>{l.set.call(this,e)},subscribe:t})}):l.constructor.addInitializer(l=>{new ht(l,{context:e,callback:e=>{l[r]=e},subscribe:t})})}}const ft="no-clamp-action-context",wt="system-banner-children-count-context";class mt extends ke{constructor(){super(...arguments),this.show=!1,this.dismissible=!1,this.noClampAction=!1,this.fluid=!1,this._intervalId=null,this._intervalTime=5e3,this._currentIndex=0}close(){this.show=!1}firstUpdated(e){super.firstUpdated(e),this.childCount=this.bannerItem.length,this.show?(this.childCount>1&&this._startAutoCycle(),this.addEventListener("mouseenter",this._pauseAutoCycle.bind(this)),this.addEventListener("mouseleave",this._resumeAutoCycle.bind(this)),this.addEventListener("focus",this._pauseAutoCycle.bind(this)),this.addEventListener("blur",this._resumeAutoCycle.bind(this))):this.banner.classList.add("d-none"),this._updateActiveItem(),this.childCount>5&&console.warn("It is not recommended to have more than 5 <sgds-system-banner-item> elements.")}disconnectedCallback(){super.disconnectedCallback(),this._stopAutoCycle()}async _handleShowChange(){this.show?(this.childCount>1&&this._startAutoCycle(),this.emit("sgds-show"),this.banner.classList.remove("d-none")):(this._stopAutoCycle(),this.emit("sgds-hide"),this.banner.classList.add("d-none"))}_updateActiveItem(){this.bannerItem.forEach((e,t)=>{t===this._currentIndex?e.setAttribute("active",""):e.removeAttribute("active")})}_next(){const e=this.bannerItem;this._currentIndex=(this._currentIndex+1)%e.length,this._updateActiveItem(),this._animateItem(e[this._currentIndex],"next"),this._resetAutoCycle()}_prev(){const e=this.bannerItem;this._currentIndex=(this._currentIndex-1+e.length)%e.length,this._updateActiveItem(),this._animateItem(e[this._currentIndex],"prev"),this._resetAutoCycle()}async _animateItem(e,t){e.getAnimations().forEach(e=>e.cancel());const l=function(e,t){const l=Ue.get(e);if(null==l?void 0:l[t])return l[t];return Ie.get(t)||{keyframes:[],options:{duration:0}}}(this,`banner.item.${t}`);var r,o,n;await(r=e,o=l.keyframes,n=l.options,new Promise(e=>{if((null==n?void 0:n.duration)===1/0)throw new Error("Promise-based animations must be finite.");const t=r.animate(o,Object.assign(Object.assign({},n),{duration:Ne()?0:null==n?void 0:n.duration}));t.addEventListener("cancel",e,{once:!0}),t.addEventListener("finish",e,{once:!0})}))}_startAutoCycle(){this._stopAutoCycle(),this._intervalId=setInterval(()=>this._next(),this._intervalTime)}_stopAutoCycle(){this._intervalId&&(clearInterval(this._intervalId),this._intervalId=null)}_resetAutoCycle(){this._stopAutoCycle(),this._startAutoCycle()}_pauseAutoCycle(){this._stopAutoCycle()}_resumeAutoCycle(){this.show&&this.childCount>1&&this._startAutoCycle()}render(){return Q`
    ...
    `}}xt.styles=[...ke.styles,bt],e([Ve({type:Boolean})],xt.prototype,"hasActionSlot",void 0),e([gt({context:ft,subscribe:!0}),Ve({type:Boolean})],xt.prototype,"noClampAction",void 0),e([He()],xt.prototype,"clamped",void 0),e([gt({context:wt,subscribe:!0}),He()],xt.prototype,"siblingsCount",void 0),customElements.define("sgds-system-banner",mt),customElements.define("sgds-system-banner-item",xt);var Ct=Q`
...
`,ol=Object.freeze({__proto__:null,default:rl}),nl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,il=Object.freeze({__proto__:null,default:nl}),al=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pl=Object.freeze({__proto__:null,default:ul}),gl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fl=Object.freeze({__proto__:null,default:gl}),wl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ir=Object.freeze({__proto__:null,default:nr}),ar=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pr=Object.freeze({__proto__:null,default:ur}),gr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fr=Object.freeze({__proto__:null,default:gr}),wr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,io=Object.freeze({__proto__:null,default:no}),ao=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,go=Object.freeze({__proto__:null,default:po}),fo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wo=Object.freeze({__proto__:null,default:fo}),mo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pn=Object.freeze({__proto__:null,default:un}),gn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fn=Object.freeze({__proto__:null,default:gn}),wn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ei=Object.freeze({__proto__:null,default:Qn}),ti=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ii=Object.freeze({__proto__:null,default:ni}),ai=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pi=Object.freeze({__proto__:null,default:ui}),gi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fi=Object.freeze({__proto__:null,default:gi}),wi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ia=Object.freeze({__proto__:null,default:na}),aa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pa=Object.freeze({__proto__:null,default:ua}),ga=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fa=Object.freeze({__proto__:null,default:ga}),wa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,is=Object.freeze({__proto__:null,default:ns}),as=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ps=Object.freeze({__proto__:null,default:us}),gs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fs=Object.freeze({__proto__:null,default:gs}),ws=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ic=Object.freeze({__proto__:null,default:nc}),ac=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,pc=Object.freeze({__proto__:null,default:uc}),gc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fc=Object.freeze({__proto__:null,default:gc}),wc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
