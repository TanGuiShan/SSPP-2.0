...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
function(t){return(e,i)=>{const{slot:n,selector:s}=t??{},o="slot"+(n?`[name=${n}]`:":not([name])");return((t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i))(e,i,{get(){const e=this.renderRoot?.querySelector(o),i=e?.assignedElements(t)??[];return void 0===s?i:i.filter(t=>t.matches(s))}})}}()],wi.prototype,"_tooltipTargetElements",void 0),_i="sgds-tooltip",vi=wi,customElements.get(_i)||customElements.define(_i,vi)});
