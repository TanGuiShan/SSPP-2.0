...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
function Oe(e){return(t,l)=>{const{slot:r,selector:i}=e??{},o="slot"+(r?`[name=${r}]`:":not([name])");return Pe(t,l,{get(){const t=this.renderRoot?.querySelector(o),l=t?.assignedElements(e)??[];return void 0===i?l:l.filter(e=>e.matches(i))}})}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
class Te{constructor(e,t,l,r){if(this.subscribe=!1,this.provided=!1,this.value=void 0,this._callback=(e,t)=>{this.unsubscribe&&(this.unsubscribe!==t&&(this.provided=!1,this.unsubscribe()),this.subscribe||this.unsubscribe()),this.value=e,this.host.requestUpdate(),this.provided&&!this.subscribe||(this.provided=!0,this.callback&&this.callback(e,t)),this.unsubscribe=t},this.host=e,void 0!==t.context){const e=t;this.context=e.context,this.callback=e.callback,this.subscribe=e.subscribe??!1}else this.context=t,this.callback=l,this.subscribe=r??!1;this.host.addController(this)}hostConnected(){this.dispatchRequest()}hostDisconnected(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=void 0)}dispatchRequest(){this.host.dispatchEvent(new Ee(this.context,this.host,this._callback,this.subscribe))}}
/**
   * @license
   * Copyright 2021 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class Re{get value(){return this._value}set value(e){this.setValue(e)}setValue(e,t=!1){const l=t||!Object.is(e,this._value);this._value=e,l&&this.updateObservers()}constructor(e){this.subscriptions=new Map,this.updateObservers=()=>{for(const[e,{disposer:t}]of this.subscriptions)e(this._value,t)},void 0!==e&&(this.value=e)}addCallback(e,t,l){if(!l)return void e(this.value);this.subscriptions.has(e)||this.subscriptions.set(e,{disposer:()=>{this.subscriptions.delete(e)},consumerHost:t});const{disposer:r}=this.subscriptions.get(e);e(this.value,r)}clearCallbacks(){this.subscriptions.clear()}}
/**
   * @license
   * Copyright 2021 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function Ne({context:e}){return(t,l)=>{const r=new WeakMap;if("object"==typeof l)return{get(){return t.get.call(this)},set(e){return r.get(this).setValue(e),t.set.call(this,e)},init(t){return r.set(this,new De(this,{context:e,initialValue:t})),t}};{t.constructor.addInitializer(t=>{r.set(t,new De(t,{context:e}))});const i=Object.getOwnPropertyDescriptor(t,l);let o;if(void 0===i){const e=new WeakMap;o={get(){return e.get(this)},set(t){r.get(this).setValue(t),e.set(this,t)},configurable:!0,enumerable:!0}}else{const e=i.set;o={...i,set(t){r.get(this).setValue(t),e?.call(this,t)}}}return void Object.defineProperty(t,l,o)}}}
/**
   * @license
...
/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,Ul=n`.text-primary{color:var(--sgds-primary-rgb)!important}.text-secondary{color:var(--sgds-secondary-rgb)!important}.text-success{color:var(--sgds-success-rgb)!important}.text-info{color:var(--sgds-info-rgb)!important}.text-warning{color:var(--sgds-warning-rgb)!important}.text-danger{color:var(--sgds-danger-rgb)!important}.text-light{color:var(--sgds-light-rgb)!important}.text-dark{color:var(--sgds-dark-rgb)!important}.text-muted{color:var(--sgds-secondary-color)!important}`;class Wl extends ke{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Sl`
    ...
    `}}Wl.styles=[...ke.styles,Ul,Nl],e([Ve({type:String,reflect:!0})],Wl.prototype,"variant",void 0),e([Ve({type:String,reflect:!0})],Wl.prototype,"tone",void 0),e([Ve({type:String,reflect:!0})],Wl.prototype,"size",void 0),e([Ve({reflect:!0,type:String})],Wl.prototype,"label",void 0),e([Ve({type:String,reflect:!0})],Wl.prototype,"orientation",void 0);var ql=n`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sgds-dimension-48,56px);min-width:unset;padding:0;width:var(--sgds-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sgds-dimension-56);min-width:unset;padding:0;width:var(--sgds-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sgds-dimension-40);min-width:unset;padding:0;width:var(--sgds-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sgds-dimension-32);min-width:unset;padding:0;width:var(--sgds-dimension-32)}`;class Fl extends Dl{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?Ll`a`:Ll`button`;return Sl`
      ...
      >
        ...
        <div class="sidebar-main">
          <div class="sidebar-wrapper">
            <div class="sidebar-top">
              ...
              ${"collapsible"===this.variant?Q`<sgds-icon-button
        ...
        >
          ${this._isNarrowViewport?Q`<sgds-icon-button
                name="chevron-left"
                variant="ghost"
                tone="neutral"
                size="sm"
    ...
    `}}Kl.styles=[...ke.styles,Xe];var Jl=n`.sidebar-section{display:flex;flex-direction:column}.sidebar-section-label{align-items:center;border-radius:var(--sgds-border-radius-md);color:var(--sgds-label-color-subtle);cursor:pointer;display:flex;font-size:var(--sgds-font-size-label-xs);gap:var(--sgds-gap-2-xs);line-height:var(--sgds-line-height-2-xs);padding:var(--sgds-padding-xs) var(--sgds-padding-sm)}.sidebar-section-label--collapsible{cursor:pointer}.sidebar-section-label--collapsible:focus-visible,.sidebar-section-label--collapsible:hover{color:var(--sgds-label-color-default)}.sidebar-section-label--collapsible:focus-visible{outline:var(--sgds-outline-focus);outline-offset:var(--sgds-outline-offset-focus)}.sidebar-section--collapsed .sidebar-section-label{height:0;margin:0;opacity:0;overflow:hidden;padding:0;pointer-events:none;width:0}.sidebar-section-content{overflow:hidden;padding:0 var(--sgds-padding-xs)}.sidebar-section-content>div{margin-top:0;pointer-events:auto;transition:all var(--sgds-motion-duration-slow) var(--sgds-motion-easing-standard)}.sidebar-section-content.sidebar-section-content--collapsed>div{margin-top:-100%;pointer-events:none}.sidebar-section--collapsed .sidebar-section-content--collapsed>div{margin-top:0}.sidebar-section-separator{margin-bottom:var(--sgds-margin-md)}`,Yl=n`:host{--container-size:8px}:host([orientation=horizontal]){border-top:var(--border-width) solid var(--sgds-border-color-muted);display:block;margin:calc((var(--container-size) - var(--border-width))/2) 0;width:100%}:host([orientation=vertical]){border-left:var(--border-width) solid var(--sgds-border-color-muted);display:inline-block;height:100%;margin:0 calc((var(--container-size) - var(--border-width))/2)}:host([thickness=thin]){--border-width:var(--sgds-border-width-1)}:host([thickness=thick]){--border-width:var(--sgds-border-width-2)}:host([thickness=thicker]){--border-width:var(--sgds-border-width-4)}`;class Xl extends ke{constructor(){super(...arguments),this.orientation="horizontal",this.thickness="thin"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator"),this.setAttribute("aria-orientation",this.orientation)}}Xl.styles=[Yl],e([Ve({type:String,reflect:!0})],Xl.prototype,"orientation",void 0),e([Ve({type:String,reflect:!0})],Xl.prototype,"thickness",void 0);class Ql extends Ol{constructor(){super(...arguments),this.title="",this.collapsed=!1,this.collapsible=!1,this.separator=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","group"),this._childLevel=-1}updated(){super.updated(),this.title?this.setAttribute("aria-label",this.title):this.removeAttribute("aria-label")}_handleClick(){this.collapsible&&(this.collapsed=!this.collapsed)}render(){return Q`
      ...
      >
        ...
        ${this.separator?Q`<sgds-divider></sgds-divider>`:le}
      </div>
    `}}Ql.styles=[...ke.styles,Jl],Ql.dependencies={"sgds-icon":lt,"sgds-divider":Xl},e([Ve({type:String,reflect:!0})],Ql.prototype,"title",void 0),e([Ve({type:Boolean,reflect:!0})],Ql.prototype,"collapsed",void 0),e([Ve({type:Boolean,reflect:!0})],Ql.prototype,"collapsible",void 0),e([Ve({type:Boolean,reflect:!0})],Ql.prototype,"separator",void 0),customElements.define("sgds-sidebar",Gl),customElements.define("sgds-sidebar-item",Kl),customElements.define("sgds-sidebar-section",Ql),customElements.define("sgds-sidebar-group",$l);var er=Q`
...
`,Qr=Object.freeze({__proto__:null,default:Xr}),ei=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qi=Object.freeze({__proto__:null,default:Xi}),eo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rd=Object.freeze({__proto__:null,default:ld}),id=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,od=Object.freeze({__proto__:null,default:id}),nd=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rh=Object.freeze({__proto__:null,default:lh}),ih=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oh=Object.freeze({__proto__:null,default:ih}),nh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
