...
/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,lt=n`.text-primary{color:var(--sgds-primary-rgb)!important}.text-secondary{color:var(--sgds-secondary-rgb)!important}.text-success{color:var(--sgds-success-rgb)!important}.text-info{color:var(--sgds-info-rgb)!important}.text-warning{color:var(--sgds-warning-rgb)!important}.text-danger{color:var(--sgds-danger-rgb)!important}.text-light{color:var(--sgds-light-rgb)!important}.text-dark{color:var(--sgds-dark-rgb)!important}.text-muted{color:var(--sgds-secondary-color)!important}`;class rt extends Ge{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Ue`
    ...
    `}}rt.styles=[...Ge.styles,lt,tt],e([Ve({type:String,reflect:!0})],rt.prototype,"variant",void 0),e([Ve({type:String,reflect:!0})],rt.prototype,"tone",void 0),e([Ve({type:String,reflect:!0})],rt.prototype,"size",void 0),e([Ve({reflect:!0,type:String})],rt.prototype,"label",void 0),e([Ve({type:String,reflect:!0})],rt.prototype,"orientation",void 0);var ot=n`:host{--input-border-radius:var(--sgds-form-border-radius-md);--input-min-width:var(--sgds-dimension-160)}.form-control-container{min-width:var(--input-min-width)}:host(.quantity-toggle) input::-webkit-inner-spin-button{appearance:none;margin:0}:host(.quantity-toggle) input{text-align:center}.form-control-prefix,.form-control-suffix{color:var(--sgds-form-color-subtle);display:flex;flex-shrink:0;font-weight:var(--sgds-font-weight-semibold);gap:var(--sgds-gap-xs)}.form-control-group.quantity-toggle{padding:0}sgds-icon[role=button]{cursor:pointer}sgds-icon[role=button]:focus,sgds-icon[role=button]:focus-visible{outline:var(--sgds-form-outline-focus)}.form-control-row{align-items:center;display:flex;gap:var(--sgds-gap-sm)}`;const it={announcement:()=>Promise.resolve().then(function(){return ut}),archive:()=>Promise.resolve().then(function(){return pt}),"arrow-bar-down":()=>Promise.resolve().then(function(){return wt}),"arrow-bar-left":()=>Promise.resolve().then(function(){return _t}),"arrow-bar-right":()=>Promise.resolve().then(function(){return xt}),"arrow-bar-up":()=>Promise.resolve().then(function(){return Ct}),"arrow-circle-down":()=>Promise.resolve().then(function(){return yt}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Ht}),"arrow-circle-right":()=>Promise.resolve().then(function(){return zt}),"arrow-circle-up":()=>Promise.resolve().then(function(){return jt}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Bt}),"arrow-down":()=>Promise.resolve().then(function(){return kt}),"arrow-left":()=>Promise.resolve().then(function(){return Lt}),"arrow-repeat":()=>Promise.resolve().then(function(){return Et}),"arrow-right":()=>Promise.resolve().then(function(){return Ut}),"arrow-square-down":()=>Promise.resolve().then(function(){return Rt}),"arrow-square-left":()=>Promise.resolve().then(function(){return Ft}),"arrow-square-right":()=>Promise.resolve().then(function(){return Wt}),"arrow-square-up":()=>Promise.resolve().then(function(){return Jt}),"arrow-up":()=>Promise.resolve().then(function(){return Xt}),"bank-fill":()=>Promise.resolve().then(function(){return Qt}),"bell-slash":()=>Promise.resolve().then(function(){return tl}),bell:()=>Promise.resolve().then(function(){return rl}),"bi-funnel":()=>Promise.resolve().then(function(){return il}),"bookmark-fill":()=>Promise.resolve().then(function(){return al}),bookmark:()=>Promise.resolve().then(function(){return sl}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return dl}),"box-seam":()=>Promise.resolve().then(function(){return ul}),building:()=>Promise.resolve().then(function(){return pl}),bus:()=>Promise.resolve().then(function(){return wl}),calculator:()=>Promise.resolve().then(function(){return _l}),"calendar-check":()=>Promise.resolve().then(function(){return xl}),"calendar-heart":()=>Promise.resolve().then(function(){return Cl}),"calendar-x":()=>Promise.resolve().then(function(){return yl}),calendar:()=>Promise.resolve().then(function(){return Hl}),camera:()=>Promise.resolve().then(function(){return zl}),car:()=>Promise.resolve().then(function(){return jl}),"chat-dots":()=>Promise.resolve().then(function(){return Bl}),"chat-left-text":()=>Promise.resolve().then(function(){return kl}),chat:()=>Promise.resolve().then(function(){return Ll}),"check-circle-fill":()=>Promise.resolve().then(function(){return El}),"check-circle":()=>Promise.resolve().then(function(){return Ul}),check:()=>Promise.resolve().then(function(){return Rl}),"chevron-down":()=>Promise.resolve().then(function(){return Fl}),"chevron-left":()=>Promise.resolve().then(function(){return Wl}),"chevron-right":()=>Promise.resolve().then(function(){return Jl}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return Xl}),"chevron-up":()=>Promise.resolve().then(function(){return Ql}),clock:()=>Promise.resolve().then(function(){return tr}),"cloud-check":()=>Promise.resolve().then(function(){return rr}),"cloud-download":()=>Promise.resolve().then(function(){return ir}),"cloud-upload":()=>Promise.resolve().then(function(){return ar}),cloud:()=>Promise.resolve().then(function(){return sr}),"code-square":()=>Promise.resolve().then(function(){return dr}),"coins-hand":()=>Promise.resolve().then(function(){return ur}),compass:()=>Promise.resolve().then(function(){return pr}),copy:()=>Promise.resolve().then(function(){return wr}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return _r}),cross:()=>Promise.resolve().then(function(){return xr}),"cursor-fill":()=>Promise.resolve().then(function(){return Cr}),cursor:()=>Promise.resolve().then(function(){return yr}),"dash-circle":()=>Promise.resolve().then(function(){return Hr}),"dash-square":()=>Promise.resolve().then(function(){return zr}),dash:()=>Promise.resolve().then(function(){return jr}),database:()=>Promise.resolve().then(function(){return Br}),dataflow:()=>Promise.resolve().then(function(){return kr}),download:()=>Promise.resolve().then(function(){return Lr}),edit:()=>Promise.resolve().then(function(){return Er}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return Ur}),"exclamation-circle":()=>Promise.resolve().then(function(){return Rr}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return Fr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return Wr}),exclamation:()=>Promise.resolve().then(function(){return Jr}),"eye-fill":()=>Promise.resolve().then(function(){return Xr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Qr}),"eye-slash":()=>Promise.resolve().then(function(){return to}),eye:()=>Promise.resolve().then(function(){return ro}),"face-smile-fill":()=>Promise.resolve().then(function(){return io}),"face-smile":()=>Promise.resolve().then(function(){return ao}),facebook:()=>Promise.resolve().then(function(){return so}),"file-earmark-text":()=>Promise.resolve().then(function(){return vo}),"file-pdf":()=>Promise.resolve().then(function(){return fo}),"file-plus":()=>Promise.resolve().then(function(){return go}),"file-text":()=>Promise.resolve().then(function(){return mo}),file:()=>Promise.resolve().then(function(){return Zo}),files:()=>Promise.resolve().then(function(){return bo}),fingerprint:()=>Promise.resolve().then(function(){return Mo}),flash:()=>Promise.resolve().then(function(){return Vo}),"folder-check":()=>Promise.resolve().then(function(){return Po}),"folder-minus":()=>Promise.resolve().then(function(){return Oo}),"folder-plus":()=>Promise.resolve().then(function(){return $o}),folder:()=>Promise.resolve().then(function(){return So}),gear:()=>Promise.resolve().then(function(){return Ao}),"geo-alt":()=>Promise.resolve().then(function(){return To}),"geo-fill":()=>Promise.resolve().then(function(){return Io}),geo:()=>Promise.resolve().then(function(){return No}),"globe-alt":()=>Promise.resolve().then(function(){return Do}),globe:()=>Promise.resolve().then(function(){return qo}),google:()=>Promise.resolve().then(function(){return Go}),"grid-alt":()=>Promise.resolve().then(function(){return Yo}),"grid-fill":()=>Promise.resolve().then(function(){return Ko}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return ei}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return li}),"hard-drive":()=>Promise.resolve().then(function(){return oi}),heart:()=>Promise.resolve().then(function(){return ni}),"house-door":()=>Promise.resolve().then(function(){return ci}),house:()=>Promise.resolve().then(function(){return hi}),image:()=>Promise.resolve().then(function(){return vi}),"in-box":()=>Promise.resolve().then(function(){return fi}),"info-circle-fill":()=>Promise.resolve().then(function(){return gi}),"info-circle":()=>Promise.resolve().then(function(){return mi}),instagram:()=>Promise.resolve().then(function(){return Zi}),key:()=>Promise.resolve().then(function(){return bi}),"laptop-gear":()=>Promise.resolve().then(function(){return Mi}),laptop:()=>Promise.resolve().then(function(){return Vi}),layers:()=>Promise.resolve().then(function(){return Pi}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Oi}),"layout-text-window":()=>Promise.resolve().then(function(){return $i}),layout:()=>Promise.resolve().then(function(){return Si}),"life-buoy":()=>Promise.resolve().then(function(){return Ai}),lightbulb:()=>Promise.resolve().then(function(){return Ti}),link:()=>Promise.resolve().then(function(){return Ii}),linkedin:()=>Promise.resolve().then(function(){return Ni}),list:()=>Promise.resolve().then(function(){return Di}),"lock-fill":()=>Promise.resolve().then(function(){return qi}),lock:()=>Promise.resolve().then(function(){return Gi}),login:()=>Promise.resolve().then(function(){return Yi}),logout:()=>Promise.resolve().then(function(){return Ki}),luggage:()=>Promise.resolve().then(function(){return en}),"mail-open":()=>Promise.resolve().then(function(){return ln}),mail:()=>Promise.resolve().then(function(){return on}),map:()=>Promise.resolve().then(function(){return an}),meetup:()=>Promise.resolve().then(function(){return sn}),menu:()=>Promise.resolve().then(function(){return dn}),microphone:()=>Promise.resolve().then(function(){return un}),monitor:()=>Promise.resolve().then(function(){return pn}),moon:()=>Promise.resolve().then(function(){return wn}),move:()=>Promise.resolve().then(function(){return _n}),paperclip:()=>Promise.resolve().then(function(){return xn}),passcode:()=>Promise.resolve().then(function(){return Cn}),passport:()=>Promise.resolve().then(function(){return yn}),pause:()=>Promise.resolve().then(function(){return Hn}),pencil:()=>Promise.resolve().then(function(){return zn}),"pending-circle":()=>Promise.resolve().then(function(){return jn}),"person-dash":()=>Promise.resolve().then(function(){return Bn}),"person-plus":()=>Promise.resolve().then(function(){return kn}),"person-x":()=>Promise.resolve().then(function(){return Ln}),person:()=>Promise.resolve().then(function(){return En}),phone:()=>Promise.resolve().then(function(){return Un}),"pin-map-fill":()=>Promise.resolve().then(function(){return Rn}),pin:()=>Promise.resolve().then(function(){return Fn}),placeholder:()=>Promise.resolve().then(function(){return Wn}),plane:()=>Promise.resolve().then(function(){return Jn}),play:()=>Promise.resolve().then(function(){return Xn}),"plus-circle":()=>Promise.resolve().then(function(){return Qn}),"plus-square":()=>Promise.resolve().then(function(){return ta}),plus:()=>Promise.resolve().then(function(){return ra}),printer:()=>Promise.resolve().then(function(){return ia}),"question-circle":()=>Promise.resolve().then(function(){return aa}),rocket:()=>Promise.resolve().then(function(){return sa}),save:()=>Promise.resolve().then(function(){return da}),search:()=>Promise.resolve().then(function(){return ua}),send:()=>Promise.resolve().then(function(){return pa}),"sg-crest":()=>Promise.resolve().then(function(){return wa}),share:()=>Promise.resolve().then(function(){return _a}),"shield-tick":()=>Promise.resolve().then(function(){return xa}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Ca}),"sidebar-expand":()=>Promise.resolve().then(function(){return ya}),"slash-circle":()=>Promise.resolve().then(function(){return Ha}),"slash-divider":()=>Promise.resolve().then(function(){return za}),sliders:()=>Promise.resolve().then(function(){return ja}),"sort-ascending":()=>Promise.resolve().then(function(){return Ba}),"sort-descending":()=>Promise.resolve().then(function(){return ka}),speedometer:()=>Promise.resolve().then(function(){return La}),"star-ai":()=>Promise.resolve().then(function(){return Ea}),"star-fill":()=>Promise.resolve().then(function(){return Ua}),star:()=>Promise.resolve().then(function(){return Ra}),stoplights:()=>Promise.resolve().then(function(){return Fa}),sun:()=>Promise.resolve().then(function(){return Wa}),"switch-horizontal":()=>Promise.resolve().then(function(){return Ja}),"switch-vertical":()=>Promise.resolve().then(function(){return Xa}),tablet:()=>Promise.resolve().then(function(){return Qa}),telegram:()=>Promise.resolve().then(function(){return tc}),telephone:()=>Promise.resolve().then(function(){return rc}),"three-dots-vertical":()=>Promise.resolve().then(function(){return ic}),"three-dots":()=>Promise.resolve().then(function(){return ac}),ticket:()=>Promise.resolve().then(function(){return sc}),"toggle-off":()=>Promise.resolve().then(function(){return dc}),"toggle-on":()=>Promise.resolve().then(function(){return uc}),train:()=>Promise.resolve().then(function(){return pc}),translate:()=>Promise.resolve().then(function(){return wc}),trash:()=>Promise.resolve().then(function(){return _c}),"trend-down":()=>Promise.resolve().then(function(){return xc}),"trend-up":()=>Promise.resolve().then(function(){return Cc}),truck:()=>Promise.resolve().then(function(){return yc}),"twitter-x":()=>Promise.resolve().then(function(){return Hc}),unlock:()=>Promise.resolve().then(function(){return zc}),upload:()=>Promise.resolve().then(function(){return jc}),"user-check":()=>Promise.resolve().then(function(){return Bc}),"user-circle":()=>Promise.resolve().then(function(){return kc}),"user-pause":()=>Promise.resolve().then(function(){return Lc}),"user-square":()=>Promise.resolve().then(function(){return Ec}),users:()=>Promise.resolve().then(function(){return Uc}),"video-recorder":()=>Promise.resolve().then(function(){return Rc}),"volume-max":()=>Promise.resolve().then(function(){return Fc}),"volume-x":()=>Promise.resolve().then(function(){return Wc}),"window-dash":()=>Promise.resolve().then(function(){return Jc}),"window-desktop":()=>Promise.resolve().then(function(){return Xc}),"window-dock":()=>Promise.resolve().then(function(){return Qc}),"window-fullscreen":()=>Promise.resolve().then(function(){return ts}),"window-plus":()=>Promise.resolve().then(function(){return rs}),"window-sidebar":()=>Promise.resolve().then(function(){return is}),"window-split":()=>Promise.resolve().then(function(){return as}),"window-stack":()=>Promise.resolve().then(function(){return ss}),"window-x":()=>Promise.resolve().then(function(){return ds}),window:()=>Promise.resolve().then(function(){return us}),"xcircle-fill":()=>Promise.resolve().then(function(){return ps}),xcircle:()=>Promise.resolve().then(function(){return ws}),youtube:()=>Promise.resolve().then(function(){return _s}),"zoom-in":()=>Promise.resolve().then(function(){return xs}),"zoom-out":()=>Promise.resolve().then(function(){return Cs})};var nt=n`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sgds-icon-size-xs);width:var(--sgds-icon-size-xs)}:host([size=sm]) svg{height:var(--sgds-icon-size-sm);width:var(--sgds-icon-size-sm)}:host([size=md]) svg{height:var(--sgds-icon-size-md);width:var(--sgds-icon-size-md)}:host([size=xl]) svg{height:var(--sgds-icon-size-xl);width:var(--sgds-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sgds-icon-size-2-xl);width:var(--sgds-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sgds-icon-size-3-xl);width:var(--sgds-icon-size-3-xl)}svg{display:inline-block;height:var(--sgds-icon-size-lg);width:var(--sgds-icon-size-lg)}`;const at=new Map;class ct extends Ge{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(at.has(e))return void(this._icon=at.get(e));const t=it[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();at.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:le}}ct.styles=[...Ge.styles,nt],e([Ve({type:String,reflect:!0})],ct.prototype,"name",void 0),e([Ve({type:String,reflect:!0})],ct.prototype,"size",void 0),e([Ve({type:String})],ct.prototype,"ariaLabel",void 0),e([He()],ct.prototype,"_icon",void 0);class st extends(Qe(Ye)){constructor(){super(...arguments),this.type="text",this.placeholder="placeholder",this.autofocus=!1,this.readonly=!1,this.autocomplete="on",this.defaultValue="",this.valid=!1,this.loading=!1,this.required=!1,this.noValidate=!1,this.value="",this._isTouched=!1,this._showPassword=!1}focus(e){this.input.focus(e)}blur(){this.input.blur()}reportValidity(){return this._mixinReportValidity()}checkValidity(){return this._mixinCheckValidity()}setValidity(e,t,l){return this._mixinSetValidity(e,t,l)}get validity(){return this._mixinGetValidity()}get validationMessage(){return this._mixinGetValidationMessage()}_handleFocus(){this.emit("sgds-focus")}_handleBlur(){const e=this.emit("sgds-blur",{cancelable:!0});this._mixinShouldSkipSgdsValidation()||e.defaultPrevented||(this.setInvalid(!this._mixinCheckValidity()),this._isTouched=!0)}_handleClick(){this.focus()}_handleChange(e){this.value=this.input.value;this.emit("sgds-change",{cancelable:!0}).defaultPrevented||super._mixinHandleChange(e)}_handleInputChange(e){this.value=this.input.value;this.emit("sgds-input",{cancelable:!0}).defaultPrevented||super._mixinHandleInputChange(e)}_handleIsTouched(){this._mixinShouldSkipSgdsValidation()||this._isTouched&&this.setInvalid(!this._mixinCheckValidity())}_handleDisabledChange(){this.setInvalid(!1)}_renderInput(){const e="both"===this.hasFeedback||"style"===this.hasFeedback,t="both"===this.hasFeedback||"text"===this.hasFeedback,l=[this.hintText?`${this._controlId}Help`:"",this.invalid&&t?`${this._controlId}-invalid`:""].filter(Boolean).join(" ")||void 0;return Ue`
      ...
      >
        ...
        <slot name="trailing-icon">
          ${this.loading?Ue`<sgds-spinner size="sm"></sgds-spinner>`:le}
          ${this.valid?Ue`<sgds-icon name="check-circle-fill" class="valid-icon"></sgds-icon>`:le}
        </slot>
      </div>
    `}_renderPasswordToggle(){return Ue`<sgds-icon
      tabIndex="0"
      role="button"
      name=${this._showPassword?"eye-slash-fill":"eye-fill"}
      @click=${()=>this._showPassword=!this._showPassword}
    ></sgds-icon>`}_inputType(){return"password"===this.type&&this._showPassword?"text":this.type}_renderFeedback(){const e="both"===this.hasFeedback||"text"===this.hasFeedback;return this.invalid&&e?Ue` <div class="invalid-feedback-container">
    ...
    `}}var ht,dt;st.styles=[...Ye.styles,Xe,qe,ot],st.dependencies={"sgds-spinner":rt,"sgds-icon":ct},e([Ve({reflect:!0})],st.prototype,"type",void 0),e([Ve({type:String})],st.prototype,"prefix",void 0),e([Ve({type:String})],st.prototype,"suffix",void 0),e([Ve({type:Number,reflect:!0})],st.prototype,"minlength",void 0),e([Ve({type:Number,reflect:!0})],st.prototype,"maxlength",void 0),e([Ve()],st.prototype,"min",void 0),e([Ve()],st.prototype,"max",void 0),e([Ve({type:String,reflect:!0})],st.prototype,"placeholder",void 0),e([Ve({type:String})],st.prototype,"pattern",void 0),e([Ve({type:Boolean,reflect:!0})],st.prototype,"autofocus",void 0),e([Ve({type:Boolean,reflect:!0})],st.prototype,"readonly",void 0),e([Ve({type:String,reflect:!0})],st.prototype,"autocomplete",void 0),e([Ve()],st.prototype,"step",void 0),e([Ve({type:String,reflect:!0})],st.prototype,"hasFeedback",void 0),e([Ve({type:String,reflect:!0})],st.prototype,"invalidFeedback",void 0),e([((e="value")=>(t,l)=>{const r=t.constructor,o=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(t,i,n){var a;const c=r.getPropertyOptions(e);if(t===("string"==typeof c.attribute?c.attribute:e).toLowerCase()){const t=c.converter||x,r=("function"==typeof t?t:null!==(a=null==t?void 0:t.fromAttribute)&&void 0!==a?a:x.fromAttribute)(n,c.type);this[e]!==r&&(this[l]=r)}o.call(this,t,i,n)}})()],st.prototype,"defaultValue",void 0),e([Ve({type:Boolean,reflect:!0})],st.prototype,"valid",void 0),e([Ve({type:Boolean,reflect:!0})],st.prototype,"loading",void 0),e([Ve({type:Boolean,reflect:!0})],st.prototype,"required",void 0),e([Ve({type:Boolean,reflect:!0})],st.prototype,"noValidate",void 0),e([Ve({reflect:!0})],st.prototype,"value",void 0),e([He()],st.prototype,"_isTouched",void 0),e([He()],st.prototype,"_showPassword",void 0),e([et("_isTouched",{waitUntilFirstUpdate:!0})],st.prototype,"_handleIsTouched",null),e([et("disabled",{waitUntilFirstUpdate:!0})],st.prototype,"_handleDisabledChange",null),ht="sgds-input",dt=st,customElements.get(ht)||customElements.define(ht,dt);var vt=Q`
...
`,il=Object.freeze({__proto__:null,default:ol}),nl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ir=Object.freeze({__proto__:null,default:or}),nr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,io=Object.freeze({__proto__:null,default:oo}),no=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ei=Object.freeze({__proto__:null,default:Qo}),ti=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oi=Object.freeze({__proto__:null,default:ri}),ii=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ni=Object.freeze({__proto__:null,default:ii}),ai=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$i=Object.freeze({__proto__:null,default:ji}),Bi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Si=Object.freeze({__proto__:null,default:Bi}),ki=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ai=Object.freeze({__proto__:null,default:ki}),Li=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ti=Object.freeze({__proto__:null,default:Li}),Ei=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ii=Object.freeze({__proto__:null,default:Ei}),Ui=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Di=Object.freeze({__proto__:null,default:Ri}),Fi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qi=Object.freeze({__proto__:null,default:Fi}),Wi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gi=Object.freeze({__proto__:null,default:Wi}),Ji=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ki=Object.freeze({__proto__:null,default:Xi}),Qi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ia=Object.freeze({__proto__:null,default:oa}),na=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ic=Object.freeze({__proto__:null,default:oc}),nc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,is=Object.freeze({__proto__:null,default:os}),ns=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
