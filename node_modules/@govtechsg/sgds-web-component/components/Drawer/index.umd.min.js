...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */let Ee;function Te(e,t){return(s,i,n)=>{const r=s=>{const n=s.renderRoot?.querySelector(e)??null;if(null===n&&t&&!s.hasUpdated){const t="object"==typeof i?i.name:i;Ee("",`@query'd field ${JSON.stringify(String(t))} with the 'cache' flag set for selector '${e}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return n};if(t){const{get:e,set:t}="object"==typeof i?s:n??(()=>{const e=Symbol(`${String(i)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Ce(s,i,{get(){let s=e.call(this);return void 0===s&&(s=r(this),(null!==s||this.hasUpdated)&&t.call(this,s)),s}})}return Ce(s,i,{get(){return r(this)}})}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */globalThis.litIssuedWarnings??=new Set,Ee=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};const Ue=1;class Ne{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,s){this.__part=e,this._$parent=t,this.__attributeIndex=s}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
   * @license
