...
import { SgdsComboBoxOption } from './sgds-combo-box-option.js';
...
class SgdsComboBox extends SelectElement {
    constructor() {
        ...
        this.suffixIconTemplate = html `<sgds-icon
...
SgdsComboBox.styles = [...SelectElement.styles, css_248z, css_248z$1];
