...
export declare class SelectElement extends SelectElement_base implements SgdsFormControl, AbstractSelectBase {
    ...
    protected _getMenuListFromOptions(assignedElements: Element[]): Promise<SgdsOptionData[]>;
