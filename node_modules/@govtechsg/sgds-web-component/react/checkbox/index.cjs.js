...
var sgdsCheckbox = require('../components/Checkbox/sgds-checkbox.cjs.js');
...
ceRegistry.register("sgds-checkbox", sgdsCheckbox.SgdsCheckbox);
var index = react.createComponent({
    react: React__namespace,
    tagName: "sgds-checkbox",
    elementClass: sgdsCheckbox.SgdsCheckbox,
    events: {
        onSgdsChange: "sgds-change",
        onSgdsBlur: "sgds-blur",
        onSgdsFocus: "sgds-focus",
        onSgdsCheck: "sgds-check",
        onSgdsUncheck: "sgds-uncheck",
