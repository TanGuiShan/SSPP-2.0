...
var sgdsSelectOption = require('./sgds-select-option.cjs.js');
...
SgdsSelect.styles = [...selectElement.SelectElement.styles, formTextControl["default"], select["default"]];
SgdsSelect.childName = "sgds-select-option";
/** @internal */
SgdsSelect.dependencies = {
    "sgds-icon": sgdsIcon.SgdsIcon,
    "sgds-spinner": sgdsSpinner.SgdsSpinner,
    [SgdsSelect.childName]: sgdsSelectOption.SgdsSelectOption
};
tslib.__decorate([
    decorators_js.property({ type: Boolean, reflect: true })
], SgdsSelect.prototype, "noValidate", void 0);
tslib.__decorate([
    decorators_js.queryAssignedElements({ flatten: true, selector: "sgds-select-option" })
], SgdsSelect.prototype, "options", void 0);
tslib.__decorate([
    watch.watch("value", { waitUntilFirstUpdate: true })
], SgdsSelect.prototype, "_handleValueChange", null);

exports.SgdsSelect = SgdsSelect;
exports["default"] = SgdsSelect;
//# sourceMappingURL=sgds-select.cjs.js.map
