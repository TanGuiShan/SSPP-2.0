...
class SgdsFileUpload extends validatorMixin.SgdsFormValidatorMixin(formControlElement["default"]) {
    ...
    _setFileList(files, previousCount = 0, deletedFile) {
        ...
        this.emit("sgds-change", { detail: files });
        ...
        if (files.length > previousCount) {
            ...
            this.emit("sgds-add-files", { detail: dt.files });
        }
        ...
        if (files.length < previousCount && deletedFile) {
            this.emit("sgds-remove-file", { detail: { file: deletedFile, files } });
        }
    }
    _handleClick(event) {
    ...
    render() {
        const getCheckedIcon = (metadata) => {
            ...
            return lit.html `<sgds-icon name="check-circle-fill" class="${iconClass}"></sgds-icon>`;
        };
        ...
        (file$1, index) => {
          ...
          <li class="file-upload-list-item-container ${this.exitingFile === file$1 ? "file-upload-exit" : ""}">
            <div class="file-upload-list-item ${(metadata === null || metadata === void 0 ? void 0 : metadata.error) ? "file-upload-error" : ""}">
              ${(metadata === null || metadata === void 0 ? void 0 : metadata.uploading) ? lit.html `<sgds-spinner size="sm"></sgds-spinner>` : getCheckedIcon(metadata)}
...
], SgdsFileUpload.prototype, "ariaLabel", void 0);
tslib.__decorate([
    decorators_js.property({ type: Boolean, reflect: true })
], SgdsFileUpload.prototype, "noValidate", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsFileUpload.prototype, "selectedFiles", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsFileUpload.prototype, "exitingFile", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsFileUpload.prototype, "fileMetadata", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsFileUpload.prototype, "_isTouched", void 0);
tslib.__decorate([
...
], SgdsFileUpload.prototype, "_handleIsTouched", null);
