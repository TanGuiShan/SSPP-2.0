...
var sgdsComboBoxOption = require('./sgds-combo-box-option.cjs.js');
...
class SgdsComboBox extends selectElement.SelectElement {
    constructor() {
        ...
        this.suffixIconTemplate = lit.html `<sgds-icon
  ...
  ></sgds-icon>`;
    ...
    async firstUpdated(changedProperties) {
        ...
        this.menuList.forEach(o => {
            const comboBoxOption = document.createElement("sgds-combo-box-option");
    ...
    async _handleInputChange(e) {
        ...
        this.emit("sgds-input", { detail: { displayValue: this.displayValue } });
        this.invalid = false;
        this.showMenu();
...
SgdsComboBox.styles = [...selectElement.SelectElement.styles, formTextControl["default"], comboBox["default"]];
SgdsComboBox.childName = "sgds-combo-box-option";
/** @internal */
SgdsComboBox.dependencies = {
    [SgdsComboBox.childName]: sgdsComboBoxOption.SgdsComboBoxOption,
...
], SgdsComboBox.prototype, "scrollBottomOffset", void 0);
tslib.__decorate([
...
tslib.__decorate([
    decorators_js.queryAssignedElements({ flatten: true, selector: "sgds-combo-box-option" })
], SgdsComboBox.prototype, "options", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsComboBox.prototype, "optionList", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsComboBox.prototype, "emptyMenuAfterFiltering", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsComboBox.prototype, "isFocused", void 0);
tslib.__decorate([
    decorators_js.state()
], SgdsComboBox.prototype, "isScrollEnd", void 0);
tslib.__decorate([
...
], SgdsComboBox.prototype, "_handleOptionListChange", null);
tslib.__decorate([
